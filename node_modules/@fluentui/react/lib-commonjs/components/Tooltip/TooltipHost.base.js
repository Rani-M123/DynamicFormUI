...
var TooltipHostBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(TooltipHostBase, _super);
    // Constructor
    ...
    TooltipHostBase.prototype.render = function () {
        ...
        var tooltipRenderProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({ id: "".concat(tooltipId, "--tooltip"), content: content, targetElement: this._getTargetElement(), directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, calloutProps: (0, Utilities_1.assign)({}, calloutProps, {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({ className: this._classNames.root, ref: this._tooltipHost }, { onFocusCapture: this._onTooltipFocus }, { onBlurCapture: this._onTooltipBlur }, { onMouseEnter: this._onTooltipMouseEnter, onMouseLeave: this._onTooltipMouseLeave, onKeyDown: this._onTooltipKeyDown, role: "none", "aria-describedby": ariaDescribedBy }),
            children,
            showTooltip && React.createElement(Tooltip_1.Tooltip, (0, tslib_1.__assign)({}, tooltipRenderProps)),
