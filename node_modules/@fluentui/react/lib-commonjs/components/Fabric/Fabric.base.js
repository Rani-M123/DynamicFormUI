...
var getFabricTheme = (0, Utilities_1.memoizeFunction)(function (theme, isRTL) { return (0, Styling_1.createTheme)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, theme), { rtl: isRTL })); });
...
function useRenderedContent(props, _a, rootElement, ref) {
    ...
    var renderedContent = (React.createElement(Utilities_1.FocusRectsProvider, { providerRef: rootElement },
        React.createElement(Root, (0, tslib_1.__assign)({ dir: rootDir }, divProps, { className: root, ref: (0, react_hooks_1.useMergedRefs)(rootElement, ref) }))));
