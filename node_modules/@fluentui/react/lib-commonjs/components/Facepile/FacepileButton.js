...
var FacepileButton = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(FacepileButton, _super);
    function FacepileButton() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FacepileButton.prototype.render = function () {
        var _a = this.props, className = _a.className, styles = _a.styles, rest = (0, tslib_1.__rest)(_a, ["className", "styles"]);
        var customStyles = (0, FacepileButton_styles_1.getStyles)(this.props.theme, className, styles);
        return (React.createElement(Button_1.BaseButton, (0, tslib_1.__assign)({}, rest, { variantClassName: "ms-Button--facepile", styles: customStyles, onRenderDescription: Utilities_1.nullRender })));
    };
    FacepileButton = (0, tslib_1.__decorate)([
