...
var FacepileBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(FacepileBase, _super);
    function FacepileBase(props) {
        ...
        _this._getPersonaControl = function (persona) {
            ...
            return (React.createElement(Persona_1.Persona, (0, tslib_1.__assign)({ imageInitials: persona.imageInitials, imageUrl: persona.imageUrl, initialsColor: persona.initialsColor, allowPhoneInitials: persona.allowPhoneInitials, text: persona.personaName, size: personaSize }, (getPersonaProps ? getPersonaProps(persona) : null), { styles: personaStyles })));
        };
        _this._getPersonaCoinControl = function (persona) {
            var _a = _this.props, getPersonaProps = _a.getPersonaProps, personaSize = _a.personaSize;
            return (React.createElement(PersonaCoin_1.PersonaCoin, (0, tslib_1.__assign)({ imageInitials: persona.imageInitials, imageUrl: persona.imageUrl, initialsColor: persona.initialsColor, allowPhoneInitials: persona.allowPhoneInitials, text: persona.personaName, size: personaSize }, (getPersonaProps ? getPersonaProps(persona) : null))));
        };
    ...
    FacepileBase.prototype._getElementWithOnClickEvent = function (personaControl, persona, showTooltip, index) {
        ...
        return (React.createElement(FacepileButton_1.FacepileButton, (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(persona, Utilities_1.buttonProperties), this._getElementProps(persona, showTooltip, index), { keytipProps: keytipProps, 
    ...
    FacepileBase.prototype._getElementWithoutOnClickEvent = function (personaControl, persona, showTooltip, index) {
        return (React.createElement("div", (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(persona, Utilities_1.buttonProperties), this._getElementProps(persona, showTooltip, index)), personaControl));
    };
    ...
    FacepileBase.prototype._getDescriptiveOverflowElement = function (personasOverflow) {
        ...
        var overflowButtonProps = (0, tslib_1.__assign)({ title: personaNames }, this.props.overflowButtonProps);
        var numPersonasNotPictured = Math.max(personasOverflow.length, 0);
        var _classNames = this._classNames;
        return (React.createElement(FacepileButton_1.FacepileButton, (0, tslib_1.__assign)({}, overflowButtonProps, { ariaDescription: overflowButtonProps.title, className: _classNames.descriptiveOverflowButton }),
    ...
    FacepileBase.prototype._getIconElement = function (icon) {
        ...
        var _classNames = this._classNames;
        return (React.createElement(FacepileButton_1.FacepileButton, (0, tslib_1.__assign)({}, overflowButtonProps, { className: _classNames.overflowButton }),
    ...
    FacepileBase.prototype._getAddNewElement = function () {
        ...
        var _classNames = this._classNames;
        return (React.createElement(FacepileButton_1.FacepileButton, (0, tslib_1.__assign)({}, addButtonProps, { className: _classNames.addButton }),
