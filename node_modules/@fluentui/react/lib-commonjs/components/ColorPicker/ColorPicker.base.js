...
var ColorPickerBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ColorPickerBase, _super);
    function ColorPickerBase(props) {
        ...
        _this._onBlur = function (event) {
            ...
            if (value.length >= minLength && (isHex || !isNaN(Number(value)))) {
                ...
                if (isHex) {
                    ...
                    newColor = (0, getColorFromRGBA_1.getColorFromRGBA)((0, correctRGB_1.correctRGB)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, color), (_a = {}, _a[component] = Number(value), _a))));
                }
        ...
        _this._strings = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, defaultStrings), { 
                    ...
                    React.createElement("tbody", null,
                        React.createElement("tr", null, colorComponents.map(function (comp) {
                            ...
                            return (React.createElement("td", { key: comp },
                                React.createElement(Tooltip_1.TooltipHost, (0, tslib_1.__assign)({ content: tooltipContent, directionalHint: DirectionalHint_1.DirectionalHint.bottomCenter, role: "alert" }, tooltipProps),
        ...
        if (!isValid) {
            ...
            var newColor = isHex
                ...
                : isTransparency
                    ...
                    : (0, getColorFromRGBA_1.getColorFromRGBA)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, color), (_a = {}, _a[component] = Number(newValue), _a)));
