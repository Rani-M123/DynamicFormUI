...
exports.CalendarBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    if (dateTimeFormatter && strings.selectedDateFormatString) {
        selectedDateString = (0, utilities_1.format)(strings.selectedDateFormatString, dateTimeFormatter.formatMonthDayYear(selectedDate, strings));
    }
    ...
    return (React.createElement("div", { id: id, ref: forwardedRef, role: "group", "aria-label": selectionAndTodayString, className: (0, utilities_1.css)(rootClass, classes.root, className, 'ms-slideDownIn10'), onKeyDown: onDatePickerPopupKeyDown },
        ...
        isDayPickerVisible && (React.createElement(CalendarDay_1.CalendarDay, (0, tslib_1.__assign)({ selectedDate: selectedDate, navigatedDate: navigatedDay, today: props.today, onSelectDate: onDateSelected, 
        ...
        isMonthPickerVisible ? (React.createElement("div", { className: classes.monthPickerWrapper },
            React.createElement(CalendarMonth_1.CalendarMonth, (0, tslib_1.__assign)({ navigatedDate: navigatedMonth, selectedDate: navigatedDay, strings: strings, 
                // eslint-disable-next-line react/jsx-no-bind
