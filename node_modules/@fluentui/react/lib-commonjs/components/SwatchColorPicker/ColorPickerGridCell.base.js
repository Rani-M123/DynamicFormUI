...
var ColorPickerGridCellBase = function (props) {
    ...
    return (React.createElement(ButtonGridCell_1.ButtonGridCell, (0, tslib_1.__assign)({ item: item, id: "".concat(idPrefix, "-").concat(item.id, "-").concat(item.index), key: item.id, disabled: disabled }, cellSemantics, { 
