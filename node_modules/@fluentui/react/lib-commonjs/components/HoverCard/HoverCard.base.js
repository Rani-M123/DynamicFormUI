...
var HoverCardBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(HoverCardBase, _super);
    // Constructor
    ...
    HoverCardBase.prototype.render = function () {
        ...
        var commonCardProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(this.props, Utilities_1.divProperties)), { id: hoverCardId, trapFocus: !!trapFocus, firstFocus: setInitialFocus || openMode === HoverCard_types_1.OpenCardMode.hotKey, targetElement: this._getTargetElement(this.props.target), onEnter: this._cardOpen, onLeave: this._childDismissEvent });
        var finalExpandedCardProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, expandingCardProps), commonCardProps), { mode: mode });
        var finalPlainCardProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, plainCardProps), commonCardProps);
        return (React.createElement("div", { className: this._classNames.host, ref: this._hoverCard, "aria-describedby": setAriaDescribedBy && isHoverCardVisible ? hoverCardId : undefined, "data-is-focusable": !this.props.target },
            children,
            isHoverCardVisible &&
                (type === HoverCard_types_1.HoverCardType.expanding ? (React.createElement(ExpandingCard_1.ExpandingCard, (0, tslib_1.__assign)({}, finalExpandedCardProps))) : (React.createElement(PlainCard_1.PlainCard, (0, tslib_1.__assign)({}, finalPlainCardProps))))));
    };
