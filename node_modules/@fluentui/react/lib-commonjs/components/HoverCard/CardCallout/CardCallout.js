...
var CardCallout = function (props) {
    ...
    var mergedCalloutProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(props, Utilities_1.divProperties)), { className: className, target: targetElement, isBeakVisible: false, directionalHint: directionalHint, directionalHintFixed: directionalHintFixed, finalHeight: finalHeight, minPagePadding: 24, onDismiss: onLeave, gapSpace: gapSpace }), calloutProps);
    return (React.createElement(React.Fragment, null, trapFocus ? (React.createElement(Callout_1.FocusTrapCallout, (0, tslib_1.__assign)({}, mergedCalloutProps, { focusTrapProps: {
            forceFocusInsideTrap: false,
            isClickableOutsideFocusTrap: true,
            disableFirstFocus: !firstFocus,
        } }), content)) : (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({}, mergedCalloutProps), content))));
};
