...
exports.FocusTrapZone = React.forwardRef(function (propsWithoutDefaults, ref) {
    ...
    return (React.createElement("div", (0, tslib_1.__assign)({ "aria-labelledby": props.ariaLabelledBy }, (0, Utilities_1.getNativeProps)(props, Utilities_1.divProperties), { ref: mergedRootRef, onFocusCapture: onRootFocusCapture, onBlurCapture: onRootBlurCapture }),
        React.createElement("div", (0, tslib_1.__assign)({}, bumperProps, { ref: firstBumper })),
        children,
        React.createElement("div", (0, tslib_1.__assign)({}, bumperProps, { ref: lastBumper }))));
});
