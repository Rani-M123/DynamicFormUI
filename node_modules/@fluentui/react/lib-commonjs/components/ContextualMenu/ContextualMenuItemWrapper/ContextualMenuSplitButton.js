...
var ContextualMenuSplitButton = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ContextualMenuSplitButton, _super);
    function ContextualMenuSplitButton(props) {
        ...
        _this._onItemMouseEnterPrimary = function (ev) {
            ...
            if (onItemMouseEnter) {
                onItemMouseEnter((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { subMenuProps: undefined, items: undefined }), ev, _this._splitButton);
            }
        };
        ...
        _this._onItemMouseMovePrimary = function (ev) {
            ...
            if (onItemMouseMove) {
                onItemMouseMove((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { subMenuProps: undefined, items: undefined }), ev, _this._splitButton);
            }
        };
    ...
    classNames, index, hasCheckmarks, hasIcons) {
        ...
        return (React.createElement("button", (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(itemProps, Utilities_1.buttonProperties)),
            React.createElement(ChildrenRenderer, (0, tslib_1.__assign)({ "data-is-focusable": false, item: itemProps, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks && onItemClick ? onItemClick : undefined, hasIcons: hasIcons }, itemComponentProps))));
    };
    ...
    index, keytipAttributes) {
        ...
        var buttonProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(itemProps, Utilities_1.buttonProperties)), {
        ...
        var itemComponentProps = item.itemProps;
        return (React.createElement("button", (0, tslib_1.__assign)({}, buttonProps),
            React.createElement(ChildrenRenderer, (0, tslib_1.__assign)({ componentRef: item.componentRef, item: itemProps, classNames: classNames, index: index, hasIcons: false, openSubMenu: openSubMenu, dismissSubMenu: dismissSubMenu, dismissMenu: dismissMenu, getSubmenuTarget: this._getSubmenuTarget }, itemComponentProps))));
    };
