...
var PivotItem = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(PivotItem, _super);
    ...
    PivotItem.prototype.render = function () {
        return React.createElement("div", (0, tslib_1.__assign)({}, (0, utilities_1.getNativeProps)(this.props, utilities_1.divProperties)), this.props.children);
    };
    return PivotItem;
}(React.Component));
