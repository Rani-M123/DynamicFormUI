...
var getLinkItems = function (props, pivotId) {
    ...
    React.Children.forEach(React.Children.toArray(props.children), function (child, index) {
        if (isPivotItem(child)) {
            ...
            var _a = child.props, linkText = _a.linkText, pivotItemProps = (0, tslib_1.__rest)(_a, ["linkText"]);
            var itemKey = child.props.itemKey || index.toString();
            result.links.push((0, tslib_1.__assign)((0, tslib_1.__assign)({ headerText: linkText }, pivotItemProps), { itemKey: itemKey }));
...
exports.PivotBase = React.forwardRef(function (props, ref) {
    ...
    var renderPivotLink = function (renderLinkCollection, link, renderPivotLinkSelectedKey, className) {
        ...
        return (React.createElement(Button_1.CommandButton, (0, tslib_1.__assign)({}, headerButtonProps, itemSemantics, { id: tabId, key: itemKey, className: (0, utilities_1.css)(className, isSelected && classNames.linkIsSelected), 
    ...
    return (React.createElement("div", (0, tslib_1.__assign)({ ref: ref }, divProps),
        React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ componentRef: focusZoneRef, role: "tablist" }, nameProps, { direction: FocusZone_1.FocusZoneDirection.horizontal }, focusZoneProps, { className: (0, utilities_1.css)(classNames.root, focusZoneProps === null || focusZoneProps === void 0 ? void 0 : focusZoneProps.className) }),
            items,
