...
exports.OverflowSetBase = React.forwardRef(function (props, forwardedRef) {
    ...
    return (React.createElement("div", (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(props, Utilities_1.divProperties), { role: role || 'group', "aria-orientation": role === 'menubar' ? (vertical === true ? 'vertical' : 'horizontal') : undefined, className: classNames.root, ref: mergedRef }),
        overflowSide === 'start' && showOverflow && React.createElement(OverflowButton_1.OverflowButton, (0, tslib_1.__assign)({}, props, { className: classNames.overflowButton })),
        items &&
        ...
        overflowSide === 'end' && showOverflow && React.createElement(OverflowButton_1.OverflowButton, (0, tslib_1.__assign)({}, props, { className: classNames.overflowButton }))));
});
