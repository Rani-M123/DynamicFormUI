...
exports.DatePickerBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    var renderReadOnlyInput = function (inputProps) {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({}, divProps, { className: (0, utilities_1.css)(divProps.className, classNames.readOnlyTextField), tabIndex: tabIndex || 0 }), formattedDate || (
    ...
    return (React.createElement("div", (0, tslib_1.__assign)({}, nativeProps, { className: classNames.root, ref: forwardedRef }),
        React.createElement("div", { ref: datePickerDiv, "aria-owns": isCalendarShown ? calloutId : undefined, className: classNames.wrapper },
            React.createElement(TextField_1.TextField, (0, tslib_1.__assign)({ role: "combobox", label: label, "aria-expanded": isCalendarShown, ariaLabel: ariaLabel, "aria-haspopup": "dialog", "aria-controls": isCalendarShown ? calloutId : undefined, required: isRequired, disabled: disabled, errorMessage: errorMessage, placeholder: placeholder, borderless: borderless, value: formattedDate, componentRef: textFieldRef, underlined: underlined, tabIndex: tabIndex, readOnly: !allowTextInput }, textFieldProps, { "data-is-focusable": dataIsFocusable, id: textFieldId, className: (0, utilities_1.css)(classNames.textField, textFieldProps && textFieldProps.className), iconProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({ iconName: 'Calendar' }, iconProps), { className: (0, utilities_1.css)(classNames.icon, iconProps && iconProps.className), onClick: onIconClick }), 
        ...
        isCalendarShown && (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({ id: calloutId, role: "dialog", ariaLabel: pickerAriaLabel, isBeakVisible: false, gapSpace: 0, doNotLayer: false, target: datePickerDiv.current, directionalHint: Callout_1.DirectionalHint.bottomLeftEdge }, calloutProps, { className: (0, utilities_1.css)(classNames.callout, calloutProps && calloutProps.className), 
            ...
            React.createElement(FocusTrapZone_1.FocusTrapZone, { isClickableOutsideFocusTrap: true, disableFirstFocus: disableAutoFocus },
                React.createElement(CalendarType, (0, tslib_1.__assign)({}, calendarProps, { 
                    // eslint-disable-next-line react/jsx-no-bind
