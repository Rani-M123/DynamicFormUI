...
var Keytip = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(Keytip, _super);
    function Keytip() {
    ...
    Keytip.prototype.render = function () {
        ...
        if (offset) {
            ...
            calloutProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, calloutProps), { coverTarget: true, directionalHint: ContextualMenu_1.DirectionalHint.topLeftEdge });
        }
        if (!calloutProps || calloutProps.directionalHint === undefined) {
            // Default callout directional hint to BottomCenter
            calloutProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, calloutProps), { directionalHint: ContextualMenu_1.DirectionalHint.bottomCenter });
        }
        return (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({}, calloutProps, { isBeakVisible: false, doNotLayer: true, minPagePadding: 0, styles: offset ? (0, Keytip_styles_1.getCalloutOffsetStyles)(offset) : Keytip_styles_1.getCalloutStyles, preventDismissOnScroll: true, target: keytipTarget }),
            React.createElement(KeytipContent_1.KeytipContent, (0, tslib_1.__assign)({}, this.props))));
    };
    return Keytip;
}(React.Component));
