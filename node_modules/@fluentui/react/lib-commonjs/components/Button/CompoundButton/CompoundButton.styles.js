...
exports.getStyles = (0, Utilities_1.memoizeFunction)(function (theme, customStyles, primary) {
    ...
    var primaryCompoundTheme = {
        description: {
            color: palette.white,
            selectors: (_a = {},
                _a[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ backgroundColor: 'WindowText', color: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _a),
        },
        descriptionHovered: {
            color: palette.white,
        ...
        descriptionPressed: {
            color: 'inherit',
            selectors: (_c = {},
                _c[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'Window', backgroundColor: 'WindowText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _c),
        },
        descriptionChecked: {
            color: 'inherit',
            selectors: (_d = {},
                _d[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'Window', backgroundColor: 'WindowText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _d),
        },
        descriptionDisabled: {
            color: 'inherit',
