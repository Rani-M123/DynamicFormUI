...
var MessageBarButton = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(MessageBarButton, _super);
    function MessageBarButton() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MessageBarButton.prototype.render = function () {
        var _a = this.props, styles = _a.styles, theme = _a.theme;
        return React.createElement(DefaultButton_1.DefaultButton, (0, tslib_1.__assign)({}, this.props, { styles: (0, MessageBarButton_styles_1.getStyles)(theme, styles), onRenderDescription: Utilities_1.nullRender }));
    };
    MessageBarButton = (0, tslib_1.__decorate)([
