...
var CalendarGridRow = function (props) {
    ...
    return (React.createElement("tr", { role: ariaRole, className: rowClassName, key: weekIndex + '_' + week[0].key },
        ...
        week.map(function (day, dayIndex) { return (React.createElement(CalendarGridDayCell_1.CalendarGridDayCell, (0, tslib_1.__assign)({}, props, { key: day.key, day: day, dayIndex: dayIndex }))); })));
};
