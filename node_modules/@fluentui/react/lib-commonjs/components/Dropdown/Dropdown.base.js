...
exports.DropdownBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    return (React.createElement(DropdownInternal, (0, tslib_1.__assign)({}, props, { responsiveMode: responsiveMode, hoisted: { rootRef: mergedRootRef, selectedIndices: selectedIndices, setSelectedIndices: setSelectedIndices } })));
});
exports.DropdownBase.displayName = 'DropdownBase';
var DropdownInternal = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(DropdownInternal, _super);
    function DropdownInternal(props) {
        ...
        _this._onChange = function (event, options, index, checked, multiSelect) {
            ...
            if (onChange || onChanged) {
                ...
                var changedOpt = multiSelect ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, options[index]), { selected: !checked }) : options[index];
                onChange && onChange((0, tslib_1.__assign)((0, tslib_1.__assign)({}, event), { target: _this._dropDown.current }), changedOpt, index);
        ...
        _this._onRenderContainer = function (props) {
            ...
            return isSmall ? (React.createElement(Panel_1.Panel, (0, tslib_1.__assign)({ closeButtonAriaLabel: "Close", focusTrapZoneProps: focusTrapZoneProps, hasCloseButton: true, isOpen: true, isLightDismiss: true, onDismiss: _this._onDismiss, styles: panelStyles }, panelProps), _this._renderFocusableList(props))) : (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({ isBeakVisible: false, gapSpace: 0, doNotLayer: false, directionalHintFixed: false, directionalHint: Callout_1.DirectionalHint.bottomLeftEdge, calloutWidth: calloutWidth, calloutMinWidth: calloutMinWidth }, calloutProps, { className: _this._classNames.callout, target: _this._dropDown.current, onDismiss: _this._onDismiss, onScroll: _this._onScroll, onPositioned: _this._onPositioned }), _this._renderFocusableList(props)));
        };
                ...
                */
                switch (item.itemType) {
                    case SelectableOption_1.SelectableOptionMenuItemType.Header:
                        ...
                        queue.items.push(onRenderItem((0, tslib_1.__assign)((0, tslib_1.__assign)({ id: id }, item), { index: index }), _this._onRenderItem));
                        queue.id = id;
                        break;
    ...
    DropdownInternal.prototype.render = function () {
        ...
        return (React.createElement("div", { className: this._classNames.root, ref: this.props.hoisted.rootRef, "aria-owns": isOpen ? this._listId : undefined },
            ...
            isOpen &&
                onRenderContainer((0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { onDismiss: this._onDismiss, onRenderItem: onRenderItem }), this._onRenderContainer),
