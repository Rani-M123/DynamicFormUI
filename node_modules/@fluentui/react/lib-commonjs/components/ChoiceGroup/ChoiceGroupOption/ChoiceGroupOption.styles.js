...
var getStyles = function (props) {
    ...
    var circleAreaProperties = [
        ...
        disabled && {
            ...
            selectors: (_a = {},
                _a[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderColor: 'GrayText', background: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _a),
        },
        checked && {
            ...
            disabled && {
                ...
                selectors: {
                    '.ms-ChoiceFieldLabel': {
                        ...
                        selectors: (_d = {},
                            _d[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'GrayText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                            _d),
                    },
                },
            },
