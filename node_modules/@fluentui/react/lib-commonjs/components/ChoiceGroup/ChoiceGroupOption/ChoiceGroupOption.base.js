...
var ChoiceGroupOptionBase = function (propsWithoutDefaults) {
    ...
    var props = (0, Utilities_1.getPropsWithDefaults)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, DEFAULT_PROPS), { key: propsWithoutDefaults.itemKey }), propsWithoutDefaults);
    var ariaLabel = props.ariaLabel, focused = props.focused, required = props.required, theme = props.theme, iconProps = props.iconProps, imageSrc = props.imageSrc, imageSize = props.imageSize, disabled = props.disabled, checked = props.checked, id = props.id, styles = props.styles, name = props.name, rest = (0, tslib_1.__rest)(props, ["ariaLabel", "focused", "required", "theme", "iconProps", "imageSrc", "imageSize", "disabled", "checked", "id", "styles", "name"]);
    ...
    var _a = (0, Utilities_1.getNativeProps)(rest, Utilities_1.inputProperties), className = _a.className, nativeProps = (0, tslib_1.__rest)(_a, ["className"]);
    ...
    var defaultOnRenderField = function () {
        ...
        var label = onRenderLabel((0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { key: props.itemKey }));
        return (React.createElement("label", { htmlFor: id, className: classNames.field },
            imageSrc && (React.createElement("div", { className: classNames.innerField },
                React.createElement("div", { className: classNames.imageWrapper },
                    React.createElement(Image_1.Image, (0, tslib_1.__assign)({ src: imageSrc, alt: imageAlt }, imageSize))),
                React.createElement("div", { className: classNames.selectedImageWrapper },
                    React.createElement(Image_1.Image, (0, tslib_1.__assign)({ src: selectedImageSrc, alt: imageAlt }, imageSize))))),
            iconProps && (React.createElement("div", { className: classNames.innerField },
                React.createElement("div", { className: classNames.iconWrapper },
                    React.createElement(Icon_1.Icon, (0, tslib_1.__assign)({}, iconProps))))),
    ...
    var onChange = function (evt) {
        var _a;
        (_a = props.onChange) === null || _a === void 0 ? void 0 : _a.call(props, evt, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { key: props.itemKey }));
    };
    ...
    var onFocus = function (evt) {
        var _a;
        (_a = props.onFocus) === null || _a === void 0 ? void 0 : _a.call(props, evt, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { key: props.itemKey }));
    };
    return (React.createElement("div", { className: classNames.root },
        React.createElement("div", { className: classNames.choiceFieldWrapper },
            React.createElement("input", (0, tslib_1.__assign)({ "aria-label": ariaLabel, id: id, className: (0, Utilities_1.css)(classNames.input, className), type: "radio", name: name, disabled: disabled, checked: checked, required: required }, nativeProps, { onChange: onChange, onFocus: onFocus, onBlur: onBlur })),
            onRenderField((0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { key: props.itemKey }), defaultOnRenderField))));
};
