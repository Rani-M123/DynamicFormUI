...
var ScrollablePaneBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ScrollablePaneBase, _super);
    function ScrollablePaneBase(props) {
        ...
        _this._getStickyContainerStyle = function (height, isTop) {
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({ height: height }, ((0, Utilities_1.getRTL)(_this.props.theme)
                ? {
                    right: '0',
    ...
    ScrollablePaneBase.prototype.render = function () {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)((0, tslib_1.__assign)({}, this.props), Utilities_1.divProperties, 
        ...
        ['onScroll']), { ref: this._root, className: classNames.root }),
            ...
            React.createElement("div", (0, tslib_1.__assign)({ ref: this._contentContainer }, scrollContainerProps, { className: classNames.contentContainer, "data-is-scrollable": true }),
