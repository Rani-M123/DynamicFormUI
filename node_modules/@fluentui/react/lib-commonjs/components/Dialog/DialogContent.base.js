...
var DialogContentBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(DialogContentBase, _super);
    ...
    DialogContentBase.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames.content },
            React.createElement("div", { className: classNames.header },
                React.createElement("div", (0, tslib_1.__assign)({ id: titleId, role: "heading", "aria-level": 1 }, titleProps, { className: (0, Utilities_1.css)(classNames.title, titleProps.className) }), title),
                React.createElement("div", { className: classNames.topButton },
                    this.props.topButtonsProps.map(function (props, index) { return (React.createElement(Button_1.IconButton, (0, tslib_1.__assign)({ key: props.uniqueId || index }, props))); }),
    ...
    DialogContentBase = (0, tslib_1.__decorate)([
