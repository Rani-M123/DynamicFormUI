...
// Constant values
var values = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, exports.DEFAULT_ROW_HEIGHTS), { rowVerticalPadding: 11, compactRowVerticalPadding: 6 });
var getDetailsRowStyles = function (props) {
    ...
    var selectedStyles = [
        ...
        classNames.isSelected,
        {
            ...
            selectors: (_a = {
                ...
                _a[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)((0, tslib_1.__assign)({ background: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()), { selectors: {
                        a: {
                            color: 'HighlightText',
                        },
                    } }),
    ...
    var defaultCellStyles = [
        ...
        isSelected && {
            selectors: (_k = {},
                _k[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ background: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _k),
        },
