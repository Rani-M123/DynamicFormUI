...
var DetailsListInner = function (props) {
    ...
    var additionalListProps = React.useMemo(function () {
        return (0, tslib_1.__assign)({ renderedWindowsAhead: isSizing ? 0 : DEFAULT_RENDERED_WINDOWS_AHEAD, renderedWindowsBehind: isSizing ? 0 : DEFAULT_RENDERED_WINDOWS_BEHIND, getKey: getKey, version: version }, listProps);
    ...
    var defaultOnRenderDetailsHeader = React.useCallback(function (detailsHeaderProps) {
        return React.createElement(DetailsHeader_1.DetailsHeader, (0, tslib_1.__assign)({}, detailsHeaderProps));
    }, []);
    ...
    var columnReorderProps = React.useMemo(function () {
        if (columnReorderOptions) {
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, columnReorderOptions), { onColumnDragEnd: onColumnDragEnd });
        }
    ...
    var finalOnRenderDetailsGroupFooter = React.useMemo(function () {
        return onRenderDetailsGroupFooter
            ? function (groupFooterProps, defaultRender) {
                return onRenderDetailsGroupFooter((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupFooterProps), { columns: adjustedColumns, groupNestingDepth: groupNestingDepth, indentWidth: indentWidth, selection: selection, selectionMode: selectionMode, viewport: viewport, checkboxVisibility: checkboxVisibility, cellStyleProps: cellStyleProps }), defaultRender);
            }
            : undefined;
    }, [
        ...
        return onRenderDetailsGroupHeader
            ...
            : function (groupHeaderProps, defaultRender) {
                ...
                var totalRowCount = groupKey !== undefined && groupedDetailsListIndexMap[groupKey]
                    ? groupedDetailsListIndexMap[groupKey].totalRowCount
                    : 0;
                return defaultRender((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupHeaderProps), { ariaColSpan: adjustedColumns.length, ariaLevel: undefined, ariaPosInSet: undefined, ariaSetSize: undefined, ariaRowCount: undefined, ariaRowIndex: groupIndex !== undefined ? totalRowCount + (isHeaderVisible ? 1 : 0) : undefined }));
            };
    }, [
    ...
    var finalGroupProps = React.useMemo(function () {
        var _a;
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps), { role: role === defaultRole ? 'rowgroup' : 'presentation', onRenderFooter: finalOnRenderDetailsGroupFooter, onRenderHeader: finalOnRenderDetailsGroupHeader, 
            // pass through custom group header checkbox label
            headerProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps === null || groupProps === void 0 ? void 0 : groupProps.headerProps), { selectAllButtonProps: (0, tslib_1.__assign)({ 'aria-label': checkButtonGroupAriaLabel }, (_a = groupProps === null || groupProps === void 0 ? void 0 : groupProps.headerProps) === null || _a === void 0 ? void 0 : _a.selectAllButtonProps) }) });
    ...
    var focusZoneInnerProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, focusZoneProps), { componentRef: focusZoneProps && focusZoneProps.componentRef ? focusZoneProps.componentRef : focusZoneRef, className: focusZoneProps && focusZoneProps.className
    ...
    return (React.createElement("div", (0, tslib_1.__assign)({ ref: rootRef, className: classNames.root, "data-automationid": "DetailsList", "data-is-scrollable": "false" }, (shouldApplyApplicationRole ? { role: 'application' } : {})),
        ...
        React.createElement("div", { role: role, "aria-label": ariaLabelForGrid || ariaLabel, "aria-rowcount": isPlaceholderData ? 0 : rowCount, "aria-colcount": colCount, "aria-busy": isPlaceholderData },
            ...
            React.createElement("div", { onKeyDown: onContentKeyDown, role: "presentation", className: classNames.contentWrapper }, !disableSelectionZone ? (React.createElement(Selection_1.SelectionZone, (0, tslib_1.__assign)({ ref: selectionZoneRef, selection: selection, selectionPreservedOnEmptyClick: selectionPreservedOnEmptyClick, selectionMode: selectionMode, isSelectedOnFocus: isSelectedOnFocus, selectionClearedOnEscapePress: isSelectedOnFocus, toggleWithoutModifierPressed: !isSelectedOnFocus, onItemInvoked: onItemInvoked, onItemContextMenu: onItemContextMenu, enterModalOnTouch: enterModalSelectionOnTouch }, (selectionZoneProps || {})), list)) : (list)),
            onRenderDetailsFooter((0, tslib_1.__assign)({}, detailsFooterProps)))));
};
var DetailsListBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(DetailsListBase, _super);
    function DetailsListBase(props) {
        ...
        _this._onRenderRow = function (props, defaultRender) {
            return React.createElement(DetailsRow_1.DetailsRow, (0, tslib_1.__assign)({}, props));
        };
        _this._getDerivedStateFromProps = function (nextProps, previousState) {
            ...
            if (shouldResetSelection) {
                ...
                nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), { focusedItemIndex: _this._initialFocusedIndex !== undefined ? _this._initialFocusedIndex : -1 });
            }
            ...
            nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), _this._adjustColumns(nextProps, nextState, true));
            ...
            if (isAllGroupsCollapsed === undefined &&
                ...
                nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), { isCollapsed: nextProps.groupProps.isAllGroupsCollapsed, isSomeGroupExpanded: !nextProps.groupProps.isAllGroupsCollapsed });
            }
            ...
            if (shouldForceUpdates) {
                nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), { version: {} });
            }
            return nextState;
        };
        ...
        _this._onColumnResized = function (resizingColumn, newWidth, resizingColumnIndex) {
            ...
            _this.setState((0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this._adjustColumns(_this.props, _this.state, true, resizingColumnIndex)), { version: {} }));
        };
        /**
    ...
    DetailsListBase.prototype._adjustColumns = function (newProps, previousState, forceUpdate, resizingColumnIndex) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, previousState), { adjustedColumns: adjustedColumns, lastWidth: viewportWidth });
    };
    ...
    DetailsListBase.prototype._getFixedColumns = function (newColumns, viewportWidth, props) {
        ...
        if (!skipViewportMeasures) {
            newColumns.forEach(function (column) {
                var newColumn = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, column), _this._columnOverrides[column.key]);
    ...
    DetailsListBase.prototype._getJustifiedColumns = function (newColumns, viewportWidth, props) {
        ...
        var adjustedColumns = newColumns.map(function (column, i) {
            var baseColumn = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, column), { calculatedWidth: column.minWidth || MIN_COLUMN_WIDTH });
            var newColumn = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, baseColumn), _this._columnOverrides[column.key]);
    ...
    DetailsListBase = (0, tslib_1.__decorate)([
