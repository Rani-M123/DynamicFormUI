...
var DetailsRowCheckBase = function (props) {
    ...
    buttonProps = (0, tslib_1.__rest)(props, ["isVisible", "canSelect", "anySelected", "selected", "selectionMode", "isHeader", "className", "checkClassName", "styles", "theme", "compact", "onRenderDetailsCheckbox", "useFastIcons"]);
    ...
    return canSelect ? (React.createElement("div", (0, tslib_1.__assign)({}, buttonProps, { role: checkRole, 
    ...
    // eslint-disable-next-line deprecation/deprecation
    React.createElement("div", (0, tslib_1.__assign)({}, divProps, { className: (0, Utilities_1.css)(classNames.root, classNames.check) })));
};
