...
var renderGroupHeader = function (props) {
    return React.createElement(GroupHeader_1.GroupHeader, (0, tslib_1.__assign)({}, props));
};
var renderGroupShowAll = function (props) {
    return React.createElement(GroupShowAll_1.GroupShowAll, (0, tslib_1.__assign)({}, props));
};
var renderGroupFooter = function (props) {
    if (props.group && props.footerText) {
        return React.createElement(GroupFooter_1.GroupFooter, (0, tslib_1.__assign)({}, props));
    }
    return null;
};
var GroupedListV2FC = function (props) {
    ...
    var renderHeader = function (item, flattenedIndex) {
        ...
        var headerProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.headerProps), getDividerProps(item.group, flattenedIndex)), { key: group.key, groupedListId: item.groupId }), ariaProps);
    ...
    var renderShowAll = function (item, flattenedIndex) {
        var group = item.group;
        var groupShowAllProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.showAllProps), getDividerProps(group, flattenedIndex)), { key: group.key ? "".concat(group.key, "-show-all") : undefined });
        return onRenderShowAll(groupShowAllProps, renderGroupShowAll);
    };
    var renderFooter = function (item, flattenedIndex) {
        var group = item.group;
        var groupFooterProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.footerProps), getDividerProps(group, flattenedIndex)), { key: group.key ? "".concat(group.key, "-footer") : undefined });
    ...
    return (React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ direction: FocusZone_1.FocusZoneDirection.vertical, "data-automationid": "GroupedList", "data-is-scrollable": "false", role: "presentation" }, focusZoneProps, { shouldEnterInnerZone: shouldEnterInnerZone, className: (0, Utilities_1.css)(classNames.root, focusZoneProps.className) }),
        React.createElement(List_1.List, (0, tslib_1.__assign)({ ref: listRef, role: role, items: listView, 
...
var GroupItem = function (_a) {
    ...
    var mergedProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { isSelected: isSelected, selected: isSelected });
    return render(mergedProps, defaultRender);
};
var GroupedListV2Wrapper = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(GroupedListV2Wrapper, _super);
    ...
    GroupedListV2Wrapper.getDerivedStateFromProps = function (nextProps, previousState) {
        ...
        var nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, previousState), { groups: groups });
    ...
    GroupedListV2Wrapper.prototype.render = function () {
        return React.createElement(exports.GroupedListV2FC, (0, tslib_1.__assign)({}, this.props, this.state, { listRef: this._list }));
    };
