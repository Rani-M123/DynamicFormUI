...
var GroupedListSection = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(GroupedListSection, _super);
    ...
    GroupedListSection.prototype.render = function () {
        ...
        var groupHeaderProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, headerProps), dividerProps), ariaControlsProps);
        var groupShowAllProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, showAllProps), dividerProps);
        var groupFooterProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, footerProps), dividerProps);
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({ ref: this._root }, (isDraggable && { draggable: true }), { className: (0, Utilities_1.css)(groupedListClassNames && groupedListClassNames.group, this._getDroppingClassName()), role: "presentation" }),
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List_1.List, (0, tslib_1.__assign)({ role: groupProps && groupProps.role ? groupProps.role : 'rowgroup', "aria-label": group === null || group === void 0 ? void 0 : group.name, items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth, group), ref: this._list, renderCount: Math.min(count, renderCount), startIndex: startIndex, onShouldVirtualize: onShouldVirtualize, id: this._id }, listProps)));
    };
