    ...
    return {
        ...
        initials: [
            classNames.initials,
            {
                ...
                height: dimension,
                selectors: (_a = {},
                    _a[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)((0, tslib_1.__assign)({ border: '1px solid WindowText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()), { color: 'WindowText', boxSizing: 'border-box', backgroundColor: 'Window !important' }),
                    _a.i = {
                        fontWeight: Styling_1.FontWeights.semibold,
                    },
                    _a),
