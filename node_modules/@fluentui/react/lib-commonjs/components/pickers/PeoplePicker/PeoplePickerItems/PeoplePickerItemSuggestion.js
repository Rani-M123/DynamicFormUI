...
var PeoplePickerItemSuggestionBase = function (props) {
    ...
    return (React.createElement("div", { className: classNames.root },
        React.createElement(Persona_1.Persona, (0, tslib_1.__assign)({ size: Persona_1.PersonaSize.size24, styles: personaStyles, className: classNames.personaWrapper, showSecondaryText: !compact, showOverflowTooltip: false }, personaProps))));
};
