            ...
            classNames.itemButton,
            {
                ...
                selectors: (_c = {},
                    _c[Styling_1.HighContrastSelector] = {
                        color: 'WindowText',
                        selectors: {
                            ':hover': (0, tslib_1.__assign)({ background: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                        },
                    },
                    _c[':hover'] = {
            ...
            suggested && [
                classNames.isSuggested,
                {
                    ...
                    selectors: (_d = {
                        ...
                        _d[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ background: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                        _d),
                },
            ],
        ],
