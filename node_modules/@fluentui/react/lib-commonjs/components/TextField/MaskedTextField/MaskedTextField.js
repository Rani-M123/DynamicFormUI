...
exports.MaskedTextField = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(TextField_1.TextField, (0, tslib_1.__assign)({}, props, { elementRef: ref, onFocus: handleFocus, onBlur: handleBlur, onMouseDown: handleMouseDown, onMouseUp: handleMouseUp, onChange: handleInputChange, onKeyDown: handleKeyDown, onPaste: handlePaste, value: displayValue || '', componentRef: textField })));
});
