...
var StackView = function (props) {
    var _a = props.as, RootType = _a === void 0 ? 'div' : _a, _b = props.disableShrink, disableShrink = _b === void 0 ? false : _b, _c = props.enableScopedSelectors, enableScopedSelectors = _c === void 0 ? false : _c, wrap = props.wrap, rest = (0, tslib_1.__rest)(props, ["as", "disableShrink", "enableScopedSelectors", "wrap"]);
    ...
    if (wrap) {
        return ((0, foundation_legacy_1.withSlots)(Slots.root, (0, tslib_1.__assign)({}, nativeProps),
            (0, foundation_legacy_1.withSlots)(Slots.inner, null, stackChildren)));
    }
    return (0, foundation_legacy_1.withSlots)(Slots.root, (0, tslib_1.__assign)({}, nativeProps), stackChildren);
};
