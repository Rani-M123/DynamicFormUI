    ...
    return {
        ...
        listItem: [
            classNames.listItem,
            {
                ...
                alignItems: 'center',
                selectors: {
                    '&:last-child .ms-Breadcrumb-itemLink': (0, tslib_1.__assign)((0, tslib_1.__assign)({}, lastChildItemStyles), (_b = {}, _b[Styling_1.HighContrastSelector] = {
        ...
        chevron: [
            classNames.chevron,
            {
                ...
                selectors: (_c = {},
                    _c[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'WindowText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
        ...
        overflowButton: [
            ...
            SingleLineTextStyle,
            {
                ...
                height: '100%',
                cursor: 'pointer',
                selectors: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, itemStateSelectors), (_d = {}, _d[MinimumScreenSelector] = {
                    padding: '4px 6px',
        ...
        itemLink: [
            ...
            SingleLineTextStyle,
            (0, tslib_1.__assign)((0, tslib_1.__assign)({}, commonItemStyles), { selectors: (0, tslib_1.__assign)((_e = { ':focus': {
        ...
        item: [
            classNames.item,
            (0, tslib_1.__assign)((0, tslib_1.__assign)({}, commonItemStyles), { selectors: {
                    ':hover': {
                        cursor: 'default',
                    },
                } }),
