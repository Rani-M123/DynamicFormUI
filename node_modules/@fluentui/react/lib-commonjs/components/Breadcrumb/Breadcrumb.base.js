...
var BreadcrumbBase = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(BreadcrumbBase, _super);
    function BreadcrumbBase(props) {
        ...
        _this._onReduceData = function (data) {
            ...
            renderedItems = (0, tslib_1.__spreadArray)([], renderedItems, true);
            renderedItems.splice(overflowIndex, 1);
            renderedOverflowItems = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], renderedOverflowItems, true), [movedItem], false);
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, data), { renderedItems: renderedItems, renderedOverflowItems: renderedOverflowItems });
        };
        /**
        ...
        _this._onGrowData = function (data) {
            ...
            renderedOverflowItems = (0, tslib_1.__spreadArray)([], renderedOverflowItems, true);
        ...
        _this._onRenderBreadcrumb = function (data) {
            ...
            return (React.createElement("div", (0, tslib_1.__assign)({ className: _this._classNames.root, role: "navigation", "aria-label": ariaLabel }, nativeProps),
                React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ componentRef: _this._focusZone, direction: FocusZone_1.FocusZoneDirection.horizontal }, _this.props.focusZoneProps),
        ...
        _this._onRenderItem = function (item) {
            ...
            var as = item.as, href = item.href, onClick = item.onClick, isCurrentItem = item.isCurrentItem, text = item.text, onRenderContent = item.onRenderContent, additionalProps = (0, tslib_1.__rest)(item, ["as", "href", "onClick", "isCurrentItem", "text", "onRenderContent"]);
            ...
            if (onClick || href) {
                return (React.createElement(Link_1.Link, (0, tslib_1.__assign)({}, additionalProps, { as: as, className: _this._classNames.itemLink, href: href, "aria-current": isCurrentItem ? 'page' : undefined, 
                    // eslint-disable-next-line react/jsx-no-bind
                    onClick: _this._onBreadcrumbClicked.bind(_this, item) }),
                    React.createElement(Tooltip_1.TooltipHost, (0, tslib_1.__assign)({ content: text, overflowMode: Tooltip_1.TooltipOverflowMode.Parent }, _this.props.tooltipHostProps), finalOnRenderContent(item))));
            }
            else {
                var Tag = as || 'span';
                return (React.createElement(Tag, (0, tslib_1.__assign)({}, additionalProps, { className: _this._classNames.item }),
                    React.createElement(Tooltip_1.TooltipHost, (0, tslib_1.__assign)({ content: text, overflowMode: Tooltip_1.TooltipOverflowMode.Parent }, _this.props.tooltipHostProps), finalOnRenderContent(item))));
            }
        };
    ...
    BreadcrumbBase.prototype.render = function () {
        ...
        var renderedItems = (0, tslib_1.__spreadArray)([], items, true);
