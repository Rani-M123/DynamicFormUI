...
function updateA(color, a) {
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, color), { a: a, t: consts_1.MAX_COLOR_ALPHA - a, str: (0, _rgbaOrHexString_1._rgbaOrHexString)(color.r, color.g, color.b, a, color.hex) });
}
