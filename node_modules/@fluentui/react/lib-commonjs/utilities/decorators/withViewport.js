...
function withViewport(ComposedComponent) {
    return /** @class */ (function (_super) {
        (0, tslib_1.__extends)(WithViewportComponent, _super);
        ...
        WithViewportComponent.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "ms-Viewport", ref: this._root, style: { minWidth: 1, minHeight: 1 } },
                React.createElement(ComposedComponent, (0, tslib_1.__assign)({ ref: this._updateComposedComponentRef, viewport: newViewport }, this.props))));
        };
