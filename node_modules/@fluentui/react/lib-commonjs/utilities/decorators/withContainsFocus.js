...
function withContainsFocus(ComposedComponent) {
    return /** @class */ (function (_super) {
        (0, tslib_1.__extends)(WithContainsFocusComponent, _super);
        ...
        WithContainsFocusComponent.prototype.render = function () {
            ...
            return (React.createElement("div", { onFocus: this._handleFocus, onBlur: this._handleBlur },
                React.createElement(ComposedComponent, (0, tslib_1.__assign)({ ref: this._updateComposedComponentRef, containsFocus: containsFocus }, this.props))));
        };
