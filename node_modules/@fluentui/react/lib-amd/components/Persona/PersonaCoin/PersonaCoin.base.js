define(["require", "exports", "tslib", "react", "../../../Utilities", "../../../Styling", "../PersonaPresence/index", "../../../Icon", "../../../Image", "../Persona.types", "../PersonaInitialsColor", "../PersonaConsts", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, index_1, Icon_1, Image_1, Persona_types_1, PersonaInitialsColor_1, PersonaConsts_1, react_hooks_1) {
    ...
    exports.PersonaCoinBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({ role: "presentation" }, divProps, { className: classNames.coin, ref: forwardedRef }),
            // Render PersonaCoin if size is not size8. size10 and tiny need to removed after a deprecation cleanup.
            // eslint-disable-next-line deprecation/deprecation
            size !== Persona_types_1.PersonaSize.size8 && size !== Persona_types_1.PersonaSize.size10 && size !== Persona_types_1.PersonaSize.tiny ? (React.createElement("div", (0, tslib_1.__assign)({ role: "presentation" }, divCoinProps, { className: classNames.imageArea, style: coinSizeStyle }),
                ...
                React.createElement(index_1.PersonaPresence, (0, tslib_1.__assign)({}, personaPresenceProps)))) : // Otherwise, render just PersonaPresence.
                props.presence ? (React.createElement(index_1.PersonaPresence, (0, tslib_1.__assign)({}, personaPresenceProps))) : (
