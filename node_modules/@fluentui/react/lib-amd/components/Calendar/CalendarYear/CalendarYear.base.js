define(["require", "exports", "tslib", "react", "../../../Utilities", "../../../FocusZone", "../../../Icon", "@fluentui/react-hooks", "../defaults"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Icon_1, react_hooks_1, defaults_1) {
    ...
    var CalendarYearGrid = function (props) {
        ...
        var renderCell = function (yearToRender) {
            ...
            return (React.createElement(CalendarYearGridCell, (0, tslib_1.__assign)({}, props, { key: yearToRender, year: yearToRender, selected: selected, current: current, disabled: disabled, onSelectYear: onSelectYear, componentRef: selected ? selectedCellRef : current ? currentCellRef : undefined, theme: theme })));
        };
        var classNames = getClassNames(styles, {
            theme: theme,
            className: className,
        ...
        return (React.createElement(FocusZone_1.FocusZone, null,
            React.createElement("div", { className: classNames.gridContainer, role: "grid", "aria-label": gridAriaLabel }, cells.map(function (cellRow, index) {
                return (React.createElement.apply(React, (0, tslib_1.__spreadArray)(["div", { key: 'yearPickerRow_' + index + '_' + fromYear, role: "row", className: classNames.buttonRow }], cellRow, false)));
            }))));
    };
    ...
    var CalendarYearNav = function (props) {
        ...
        return (React.createElement("div", { className: classNames.navigationButtonsContainer },
            React.createElement(CalendarYearNavArrow, (0, tslib_1.__assign)({}, props, { direction: CalendarYearNavDirection.Previous })),
            React.createElement(CalendarYearNavArrow, (0, tslib_1.__assign)({}, props, { direction: CalendarYearNavDirection.Next }))));
    };
    ...
    var CalendarYearHeader = function (props) {
        ...
        return (React.createElement("div", { className: classNames.headerContainer }, (_a = onRenderTitle === null || onRenderTitle === void 0 ? void 0 : onRenderTitle(props)) !== null && _a !== void 0 ? _a : React.createElement(CalendarYearTitle, (0, tslib_1.__assign)({}, props)),
            React.createElement(CalendarYearNav, (0, tslib_1.__assign)({}, props))));
    };
    ...
    var CalendarYearBase = function (props) {
        ...
        return (React.createElement("div", { className: classNames.root },
            React.createElement(CalendarYearHeader, (0, tslib_1.__assign)({}, props, { fromYear: fromYear, toYear: toYear, onSelectPrev: onNavPrevious, onSelectNext: onNavNext, animateBackwards: animateBackwards })),
            React.createElement(CalendarYearGrid, (0, tslib_1.__assign)({}, props, { fromYear: fromYear, toYear: toYear, animateBackwards: animateBackwards, componentRef: gridRef }))));
    };
