define(["require", "exports", "tslib", "react", "../../Utilities", "./ExpandingCard.types", "./CardCallout/CardCallout"], function (require, exports, tslib_1, React, Utilities_1, ExpandingCard_types_1, CardCallout_1) {
    ...
    var ExpandingCardBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ExpandingCardBase, _super);
        ...
        ExpandingCardBase.prototype.render = function () {
            ...
            return (React.createElement(CardCallout_1.CardCallout, (0, tslib_1.__assign)({}, this.props, { content: content, finalHeight: finalHeight, className: this._classNames.root })));
        };
