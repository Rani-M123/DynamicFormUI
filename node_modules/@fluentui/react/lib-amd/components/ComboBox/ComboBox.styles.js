define(["require", "exports", "tslib", "../../Styling", "../../Utilities"], function (require, exports, tslib_1, Styling_1, Utilities_1) {
    ...
    var listOptionHighContrastStyles = {
        selectors: (_a = {},
            _a[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ backgroundColor: 'Highlight', borderColor: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
            _a),
    };
    var inputHighContrastStyles = {
        selectors: (_b = {},
            _b[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'WindowText', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
            _b),
    };
        ...
        var optionStyles = {
            root: [
                theme.fonts.medium,
                {
                    ...
                    textAlign: 'left',
                    selectors: (0, tslib_1.__assign)((0, tslib_1.__assign)((_a = {}, _a[Styling_1.HighContrastSelector] = {
                        border: 'none',
    ...
    exports.getCaretDownButtonStyles = (0, Utilities_1.memoizeFunction)(function (theme, customStyles) {
        ...
        var styles = {
            root: {
                ...
                cursor: 'default',
                selectors: (_b = {},
                    _b[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ backgroundColor: 'ButtonFace', borderColor: 'ButtonText', color: 'ButtonText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                    _b),
            },
            icon: {
                fontSize: fonts.small.fontSize,
    ...
    exports.getStyles = (0, Utilities_1.memoizeFunction)(function (theme, customStyles, comboBoxOptionWidth) {
        ...
        var ComboBoxRootHighContrastFocused = (0, tslib_1.__assign)((0, tslib_1.__assign)({ color: 'HighlightText', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()), { selectors: {
                ':after': {
        ...
        var styles = {
            ...
            rootHovered: {
                selectors: (_c = {
                    ...
                    _c[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)((0, tslib_1.__assign)({ color: 'HighlightText', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()), { selectors: {
                            ':after': {
                                borderColor: 'Highlight',
                            },
                        } }),
            ...
            header: [
                fonts.medium,
                {
                    ...
                    textAlign: 'left',
                    selectors: (_f = {},
                        _f[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'GrayText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                        _f),
                },
            ],
            divider: {
