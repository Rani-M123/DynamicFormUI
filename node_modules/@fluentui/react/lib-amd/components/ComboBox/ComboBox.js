define(["require", "exports", "tslib", "react", "../../Autofill", "../../Utilities", "../../Callout", "../../Checkbox", "./ComboBox.styles", "./ComboBox.classNames", "../../Label", "../../SelectableOption", "../../Button", "@fluentui/react-hooks", "@fluentui/utilities"], function (require, exports, tslib_1, React, Autofill_1, Utilities_1, Callout_1, Checkbox_1, ComboBox_styles_1, ComboBox_classNames_1, Label_1, SelectableOption_1, Button_1, react_hooks_1, utilities_1) {
    ...
    var ComboBoxOptionWrapper = React.memo(function (_a) {
        ...
        var oldRender = _a.render, oldProps = (0, tslib_1.__rest)(_a, ["render"]);
        var newRender = _b.render, newProps = (0, tslib_1.__rest)(_b, ["render"]);
    ...
    exports.ComboBox = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        var _a = (0, Utilities_1.getPropsWithDefaults)(DEFAULT_PROPS, propsWithoutDefaults), ref = _a.ref, props = (0, tslib_1.__rest)(_a, ["ref"]);
        ...
        return (React.createElement(ComboBoxInternal, (0, tslib_1.__assign)({}, props, { hoisted: {
    ...
    var ComboBoxInternal = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ComboBoxInternal, _super);
        function ComboBoxInternal(props) {
            ...
            _this._onResolveOptions = function () {
                if (_this.props.onResolveOptions) {
                    // get the options
                    var newOptions_1 = _this.props.onResolveOptions((0, tslib_1.__spreadArray)([], _this.props.hoisted.currentOptions, true));
            ...
            _this._onRenderContainer = function (props, defaultRender) {
                ...
                return (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({ isBeakVisible: false, gapSpace: 0, doNotLayer: false, directionalHint: Callout_1.DirectionalHint.bottomLeftEdge, directionalHintFixed: false }, calloutProps, { onLayerMounted: _this._onLayerMounted, className: (0, Utilities_1.css)(_this._classNames.callout, calloutProps === null || calloutProps === void 0 ? void 0 : calloutProps.className), target: _this._comboBoxWrapper.current, onDismiss: _this._onDismiss, onMouseDown: _this._onCalloutMouseDown, onScroll: _this._onScroll, setInitialFocus: false, calloutWidth: useComboBoxAsMenuWidth && _this._comboBoxWrapper.current
                    ...
                    React.createElement("div", { className: _this._classNames.optionsContainerWrapper, ref: _this._comboBoxMenu }, onRenderList === null || onRenderList === void 0 ? void 0 : onRenderList((0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { id: id }), _this._onRenderList)),
            ...
            _this._onRenderList = function (props) {
                ...
                var emptyQueue = function () {
                    var newGroup = queue.id
                        ...
                        : queue.items;
                    renderedList = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], renderedList, true), newGroup, true);
                    // Flush items and id
                    queue = { items: [] };
                };
                    ...
                    */
                    switch (item.itemType) {
                        case SelectableOption_1.SelectableOptionMenuItemType.Header:
                            ...
                            queue.items.push(onRenderItem((0, tslib_1.__assign)((0, tslib_1.__assign)({ id: id_1 }, item), { index: index }), _this._onRenderItem));
                            queue.id = id_1;
                            break;
                        case SelectableOption_1.SelectableOptionMenuItemType.Divider:
                            index > 0 && queue.items.push(onRenderItem((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index }), _this._onRenderItem));
                            queue.items.length > 0 && emptyQueue();
                            break;
                        default:
                            queue.items.push(onRenderItem((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index }), _this._onRenderItem));
                    }
                };
            ...
            _this._renderOption = function (item) {
                ...
                var getOptionComponent = function () {
                    return !_this.props.multiSelect ? (React.createElement(Button_1.CommandButton, { id: id, key: item.key, "data-index": item.index, styles: optionStyles, checked: isSelected, className: 'ms-ComboBox-option', onClick: _this._onItemClick(item), 
                        ...
                        // eslint-disable-next-line react/jsx-no-bind
                        onRenderLabel: _this._renderCheckboxLabel.bind(_this, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { id: id + '-label' })), inputProps: (0, tslib_1.__assign)({ 
        ...
        ComboBoxInternal.prototype.componentDidUpdate = function (prevProps, prevState) {
            ...
            var options = currentOptions.map(function (item, index) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index })); });
        ...
        ComboBoxInternal.prototype._processInputChangeWithFreeform = function (updatedValue) {
            ...
            if (updatedValue === '') {
                var items = currentOptions
                    .map(function (item, index) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index })); })
        ...
        ComboBoxInternal.prototype._updateAutocompleteIndexWithoutFreeform = function (updatedValue) {
            ...
            // If autoComplete is on, attempt to find a match where the text of an option starts with the updated value
            var items = currentOptions
                .map(function (item, i) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: i })); })
                .filter(function (option) {
        ...
        ComboBoxInternal.prototype._setSelectedIndex = function (index, submitPendingValueEvent, searchDirection) {
            ...
            if (this.props.multiSelect ||
                ...
                var option = (0, tslib_1.__assign)({}, currentOptions[index]);
                        ...
                        if (option.selected) {
                            currentOptions.forEach(function (currentOption, i) {
                                if (!currentOption.disabled && isSelectableOption(currentOption)) {
                                    ...
                                    changedOptions[i] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentOption), { selected: true });
                                }
                            });
                        }
                        // otherwise un-check all options
                        else {
                            changedOptions = currentOptions.map(function (currentOption) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentOption), { selected: false })); });
                        }
                    }
                    // otherwise update the individual option
                        ...
                        if (selectAllOption) {
                            ...
                            if (selectAllState) {
                                ...
                                changedOptions[selectAllIndex_1] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, selectAllOption), { selected: true });
                            }
                            else {
                                selectedIndices = selectedIndices.filter(function (value) { return value !== selectAllIndex_1; });
                                changedOptions[selectAllIndex_1] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, selectAllOption), { selected: false });
                            }
                        }
                    }
                }
        ...
        ComboBoxInternal = (0, tslib_1.__decorate)([
