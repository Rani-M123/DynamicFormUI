define(["require", "exports", "tslib", "react", "./ComboBox", "../../List", "../../Utilities"], function (require, exports, tslib_1, React, ComboBox_1, List_1, Utilities_1) {
    ...
    var VirtualizedComboBox = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(VirtualizedComboBox, _super);
        ...
        VirtualizedComboBox.prototype.render = function () {
            return (React.createElement(ComboBox_1.ComboBox, (0, tslib_1.__assign)({}, this.props, { componentRef: this._comboBox, onRenderList: this._onRenderList, onScrollToItem: this._onScrollToItem })));
        };
