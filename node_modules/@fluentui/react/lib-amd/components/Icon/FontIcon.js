define(["require", "exports", "tslib", "react", "./Icon.styles", "../../Utilities", "../../Styling"], function (require, exports, tslib_1, React, Icon_styles_1, Utilities_1, Styling_1) {
    ...
    var FontIcon = function (props) {
        ...
        return (React.createElement("i", (0, tslib_1.__assign)({ "data-icon-name": iconName }, containerProps, nativeProps, (mergeImageProps
            ? {
                title: undefined,
            ...
            style: (0, tslib_1.__assign)({ fontFamily: fontFamily }, style) }), finalChildren));
    };
