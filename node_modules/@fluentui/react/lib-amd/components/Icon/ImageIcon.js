define(["require", "exports", "tslib", "react", "../Image/Image", "../../Utilities", "./Icon.styles"], function (require, exports, tslib_1, React, Image_1, Utilities_1, Icon_styles_1) {
    ...
    var ImageIcon = function (props) {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({}, containerProps, nativeProps, { className: (0, Utilities_1.css)(Icon_styles_1.MS_ICON, Icon_styles_1.classNames.root, Icon_styles_1.classNames.image, className) }),
            React.createElement(Image_1.Image, (0, tslib_1.__assign)({}, imageNameProps, imageProps, { alt: hasName ? altText : '' }))));
    };
