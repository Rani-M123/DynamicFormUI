        ...
        return {
            ...
            wrapper: [
                ...
                underlined && [
                    ...
                    disabled && {
                        ...
                        selectors: (_d = {},
                            _d[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderColor: 'GrayText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                            _d),
                    },
                    !disabled && {
                        selectors: {
                            ':hover': {
                                ...
                                selectors: (_e = {},
                                    _e[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderBottomColor: 'Highlight' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                                    _e),
                            },
                        },
                    },
            ...
            fieldGroup: [
                ...
                !focused &&
                    ...
                    selectors: {
                        ':hover': {
                            ...
                            selectors: (_f = {},
                                _f[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderColor: 'Highlight' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                                _f),
                        },
                    },
                },
                ...
                disabled && {
                    ...
                    selectors: (_g = {},
                        _g[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderColor: 'GrayText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                        _g),
                    cursor: 'default',
                },
                borderless && {
