define(["require", "exports", "tslib", "react", "../../Utilities", "./GroupedListSection", "../../List", "../../Selection", "../DetailsList/DetailsRow.styles", "../../FocusZone"], function (require, exports, tslib_1, React, Utilities_1, GroupedListSection_1, List_1, Selection_1, DetailsRow_styles_1, FocusZone_1) {
    ...
    var GroupedListBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(GroupedListBase, _super);
        function GroupedListBase(props) {
            ...
            _this._renderGroup = function (group, groupIndex) {
                ...
                var headerProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.headerProps), dividerProps);
                var showAllProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.showAllProps), dividerProps);
                var footerProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupProps.footerProps), dividerProps);
                var groupNestingDepth = _this._getGroupNestingDepth();
                if (!groupProps.showEmptyGroups && group && group.count === 0) {
                    return null;
                }
                var finalListProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (listProps || {})), { version: _this.state.version });
        ...
        GroupedListBase.getDerivedStateFromProps = function (nextProps, previousState) {
            ...
            var nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, previousState), { selectionMode: selectionMode, compact: compact, groups: groups, listProps: listProps, items: items });
        ...
        GroupedListBase.prototype.render = function () {
            ...
            return (React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ direction: FocusZone_1.FocusZoneDirection.vertical, "data-automationid": "GroupedList", "data-is-scrollable": "false", role: "presentation" }, focusZoneProps, { shouldEnterInnerZone: shouldEnterInnerZone, className: (0, Utilities_1.css)(this._classNames.root, focusZoneProps.className) }), !groups ? (this._renderGroup(undefined, 0)) : (React.createElement(List_1.List, (0, tslib_1.__assign)({ ref: this._list, role: role, items: groups, onRenderCell: this._renderGroup, getItemCountForPage: this._returnOne, getPageHeight: this._getPageHeight, getPageSpecification: this._getPageSpecification, usePageCache: usePageCache, onShouldVirtualize: onShouldVirtualize, version: version }, rootListProps)))));
        };
