        ...
        return {
            ...
            checkbox: [
                ...
                (_o = {
                    ...
                    _o[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ borderColor: 'WindowText' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                    _o),
                indeterminate && {
            ...
            checkmark: [
                ...
                (_s = {
                    ...
                    _s[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: disabled ? 'GrayText' : 'Window' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                    _s),
            ],
            text: [
                classNames.text,
                (_t = {
                    ...
                    _t[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: disabled ? 'GrayText' : 'WindowText' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                    _t),
                !reversed
                    ? {
                        marginLeft: 4,
