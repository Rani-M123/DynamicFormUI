define(["require", "exports", "tslib", "react", "../../Utilities", "./ResizeGroup.types", "@fluentui/react-hooks", "../../WindowProvider"], function (require, exports, tslib_1, React, Utilities_1, ResizeGroup_types_1, react_hooks_1, WindowProvider_1) {
    ...
    var getNextResizeGroupStateProvider = function (measurementCache) {
        ...
        function _growDataUntilItDoesNotFit(data, onGrowData, getElementToMeasureDimension, onReduceData) {
            ...
            return (0, tslib_1.__assign)({ resizeDirection: 'shrink' }, _shrinkContentsUntilTheyFit(dataToMeasure, onReduceData, getElementToMeasureDimension));
        }
        /**
        ...
        function _updateContainerDimension(newDimension, fullDimensionData, renderedData, onGrowData) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), { measureContainer: false });
        }
        function getNextState(props, currentState, getElementToMeasureDimension, newContainerDimension) {
            ...
            if (newContainerDimension) {
                ...
                if (_containerDimension && currentState.renderedData && !currentState.dataToMeasure) {
                    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentState), _updateContainerDimension(newContainerDimension, props.data, currentState.renderedData, props.onGrowData));
                }
            ...
            var nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentState), { measureContainer: false });
            if (currentState.dataToMeasure) {
                if (currentState.resizeDirection === 'grow' && props.onGrowData) {
                    nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), _growDataUntilItDoesNotFit(currentState.dataToMeasure, props.onGrowData, getElementToMeasureDimension, props.onReduceData));
                }
                else {
                    nextState = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, nextState), _shrinkContentsUntilTheyFit(currentState.dataToMeasure, props.onReduceData, getElementToMeasureDimension));
                }
            }
            return nextState;
        }
        ...
        function getInitialResizeGroupState(data) {
            return {
                dataToMeasure: (0, tslib_1.__assign)({}, data),
                resizeDirection: 'grow',
    ...
    function resizeDataReducer(state, action) {
        ...
        switch (action.type) {
            case 'resizeData':
                return (0, tslib_1.__assign)({}, action.value);
            case 'dataToMeasure':
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, state), { dataToMeasure: action.value, resizeDirection: 'grow', measureContainer: true });
            default:
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, state), (_a = {}, _a[action.type] = action.value, _a));
        }
    }
    function useResizeState(props, nextResizeGroupStateProvider, rootRef) {
        ...
        stateRef.current = (0, tslib_1.__assign)({}, resizeData);
    ...
    exports.ResizeGroupBase = React.forwardRef(function (props, forwardedRef) {
        ...
        return (React.createElement("div", (0, tslib_1.__assign)({}, divProps, { className: className, ref: mergedRootRef }),
