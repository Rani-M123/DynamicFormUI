define(["require", "exports", "tslib", "react", "../../Button", "../../Layer", "../../Overlay", "../../Popup", "../../Utilities", "../FocusTrapZone/index", "./Panel.types"], function (require, exports, tslib_1, React, Button_1, Layer_1, Overlay_1, Popup_1, Utilities_1, index_1, Panel_types_1) {
    ...
    var PanelBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(PanelBase, _super);
            ...
            _this._onRenderHeader = function (props, defaultRender, headerTextId) {
                ...
                if (headerText) {
                    return (React.createElement("div", { className: _this._classNames.header },
                        React.createElement("div", (0, tslib_1.__assign)({ id: headerTextId, role: "heading", "aria-level": 1 }, headerTextProps, { className: (0, Utilities_1.css)(_this._classNames.headerText, headerTextProps.className) }), headerText)));
                }
                return null;
            };
        ...
        PanelBase.prototype.render = function () {
            ...
            if (isBlocking && isOpen) {
                overlay = (React.createElement(Overlay_1.Overlay, (0, tslib_1.__assign)({ className: _classNames.overlay, isDarkThemed: false, onClick: isLightDismiss ? onLightDismissClick : undefined, allowTouchBodyScroll: _allowTouchBodyScroll }, overlayProps)));
            }
            return (React.createElement(Layer_1.Layer, (0, tslib_1.__assign)({}, layerProps),
                React.createElement(Popup_1.Popup, (0, tslib_1.__assign)({ role: "dialog", "aria-modal": isBlocking ? 'true' : undefined, ariaLabelledBy: this._headerTextId ? this._headerTextId : undefined, onDismiss: this.dismiss, className: _classNames.hiddenPanel, enableAriaHiddenSiblings: isOpen ? true : false }, popupProps),
                    React.createElement("div", (0, tslib_1.__assign)({ "aria-hidden": !isOpen && isAnimating }, nativeProps, { ref: this._panel, className: _classNames.root }),
                        overlay,
                        React.createElement(index_1.FocusTrapZone, (0, tslib_1.__assign)({ ignoreExternalFocusing: ignoreExternalFocusing, forceFocusInsideTrap: !isBlocking || (isHiddenOnDismiss && !isOpen) ? false : forceFocusInsideTrap, firstFocusableSelector: firstFocusableSelector, isClickableOutsideFocusTrap: true }, focusTrapZoneProps, { className: _classNames.main, style: customWidthStyles, elementToFocusOnDismiss: elementToFocusOnDismiss }),
