define(["require", "exports", "tslib", "react", "../../../Utilities", "../Shimmer.types", "../ShimmerLine/ShimmerLine", "../ShimmerGap/ShimmerGap", "../ShimmerCircle/ShimmerCircle"], function (require, exports, tslib_1, React, Utilities_1, Shimmer_types_1, ShimmerLine_1, ShimmerGap_1, ShimmerCircle_1) {
    ...
    function getRenderedElements(shimmerElements, backgroundColor, rowHeight) {
        ...
        function (element, index) {
            var type = element.type, filteredElem = (0, tslib_1.__rest)(element, ["type"]);
            ...
            switch (element.type) {
                case Shimmer_types_1.ShimmerElementType.circle:
                    return React.createElement(ShimmerCircle_1.ShimmerCircle, (0, tslib_1.__assign)({ key: index }, filteredElem, { styles: styles }));
                case Shimmer_types_1.ShimmerElementType.gap:
                    return React.createElement(ShimmerGap_1.ShimmerGap, (0, tslib_1.__assign)({ key: index }, filteredElem, { styles: styles }));
                case Shimmer_types_1.ShimmerElementType.line:
                    return React.createElement(ShimmerLine_1.ShimmerLine, (0, tslib_1.__assign)({ key: index }, filteredElem, { styles: styles }));
            }
    ...
    var getElementStyles = (0, Utilities_1.memoizeFunction)(function (verticalAlign, elementType, elementHeight, backgroundColor, rowHeight) {
        ...
        if (backgroundColor) {
            switch (elementType) {
                case Shimmer_types_1.ShimmerElementType.circle:
                    return {
                        root: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, borderStyle), { borderColor: backgroundColor }),
                        svg: { fill: backgroundColor },
                    };
                case Shimmer_types_1.ShimmerElementType.gap:
                    return {
                        root: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, borderStyle), { borderColor: backgroundColor, backgroundColor: backgroundColor }),
                    };
                case Shimmer_types_1.ShimmerElementType.line:
                    return {
                        root: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, borderStyle), { borderColor: backgroundColor }),
