    ...
    exports.SwatchColorPickerBase = React.forwardRef(function (props, ref) {
        ...
        var itemsWithIndex = React.useMemo(function () {
            return colorCells.map(function (item, index) {
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index });
            });
        }, [colorCells]);
        ...
        return (React.createElement(ButtonGrid_1.ButtonGrid, (0, tslib_1.__assign)({}, props, { ref: ref, id: id, items: itemsWithIndex, columnCount: columnCount, isSemanticRadio: isSemanticRadio, 
