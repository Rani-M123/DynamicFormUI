    ...
    var List = /** @class */ (function (_super) {
        ...
        function List(props) {
            ...
            _this._onRenderRoot = function (props) {
                ...
                return (React.createElement("div", (0, tslib_1.__assign)({ ref: rootRef }, divProps), surfaceElement));
            };
            _this._onRenderSurface = function (props) {
                ...
                return (React.createElement("div", (0, tslib_1.__assign)({ ref: surfaceRef }, divProps), pageElements));
            };
            _this._onRenderPage = function (pageProps, defaultRender) {
                ...
                var _c = pageProps.page, _d = _c.items, items = _d === void 0 ? [] : _d, startIndex = _c.startIndex, divProps = (0, tslib_1.__rest)(pageProps, ["page"]);
                ...
                return React.createElement("div", (0, tslib_1.__assign)({}, divProps), cells);
            };
        ...
        List.prototype.componentDidMount = function () {
            ...
            this._scrollTop = 0;
            this.setState((0, tslib_1.__assign)((0, tslib_1.__assign)({}, this._updatePages(this.props, this.state)), { hasMounted: true }));
        ...
        List.prototype.render = function () {
            ...
            return finalOnRenderRoot({
                ...
                divProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, divProps), { className: (0, Utilities_1.css)('ms-List', className), role: pageElements.length > 0 ? role : undefined, 'aria-label': pageElements.length > 0 ? divProps['aria-label'] : undefined }),
            });
        };
        ...
        List.prototype._getPageStyle = function (page) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (getPageStyle ? getPageStyle(page) : {})), (!page.items
                ? {
                    height: page.height,
                }
                : {}));
        ...
        List.prototype._updatePages = function (nextProps, previousState) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, previousState), newListState), { pagesVersion: {} });
        };
        /**
        ...
        List.prototype._buildPages = function (props, state) {
            ...
            var materializedRect = (0, tslib_1.__assign)({}, EMPTY_RECT);
            var pages = [];
            var itemsPerPage = 1;
            var pageTop = 0;
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, state), { pages: pages, measureVersion: this._measureVersion });
        };
        ...
        List.prototype._updateRenderRects = function (props, state, forceUpdate) {
            ...
            var surfaceRect = this._surfaceRect || (0, tslib_1.__assign)({}, EMPTY_RECT);
