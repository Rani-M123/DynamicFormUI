define(["require", "exports", "tslib", "react", "../../Utilities"], function (require, exports, tslib_1, React, Utilities_1) {
    ...
    var AnnouncedBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(AnnouncedBase, _super);
        ...
        AnnouncedBase.prototype.render = function () {
            ...
            return (React.createElement(Root, (0, tslib_1.__assign)({ role: "status", className: classNames.root }, (0, Utilities_1.getNativeProps)(this.props, Utilities_1.divProperties, ['className'])),
