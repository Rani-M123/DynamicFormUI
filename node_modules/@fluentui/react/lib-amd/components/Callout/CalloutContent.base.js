define(["require", "exports", "tslib", "react", "../../common/DirectionalHint", "../../Utilities", "../../Positioning", "../../Popup", "../../Utilities", "../../Styling", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, DirectionalHint_1, Utilities_1, Positioning_1, Popup_1, Utilities_2, Styling_1, react_hooks_1) {
            ...
            if (!hidden) {
                var timerId_1 = async.requestAnimationFrame(function () {
                    ...
                    if (hostElement.current && calloutElement) {
                        var currentProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { target: targetRef.current, bounds: getBounds() });
    ...
    exports.CalloutContentBase = React.memo(React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        ...
        var cssPositions = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, positions === null || positions === void 0 ? void 0 : positions.elementPosition), { maxHeight: maxHeight });
        if (isForcedInBounds) {
        ...
        var overflowStyle = (0, tslib_1.__assign)((0, tslib_1.__assign)({ maxHeight: calloutMaxHeight ? calloutMaxHeight : '100%' }, style), (overflowYHidden && { overflowY: 'hidden' }));
        ...
        return (React.createElement("div", { ref: rootRef, className: classNames.container, style: visibilityStyle },
            React.createElement("div", (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(props, Utilities_1.divProperties, ARIA_ROLE_ATTRIBUTES), { className: (0, Utilities_1.css)(classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]), style: positions ? (0, tslib_1.__assign)({}, cssPositions) : OFF_SCREEN_STYLE, 
    ...
    function getBeakPosition(positions) {
        var _a, _b;
        var beakPositionStyle = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (_a = positions === null || positions === void 0 ? void 0 : positions.beakPosition) === null || _a === void 0 ? void 0 : _a.elementPosition), { display: ((_b = positions === null || positions === void 0 ? void 0 : positions.beakPosition) === null || _b === void 0 ? void 0 : _b.hideBeak) ? 'none' : undefined });
