define(["require", "exports", "tslib", "react", "./Callout", "../../FocusTrapZone"], function (require, exports, tslib_1, React, Callout_1, FocusTrapZone_1) {
    ...
    var FocusTrapCallout = function (props) {
        return (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({}, props),
            React.createElement(FocusTrapZone_1.FocusTrapZone, (0, tslib_1.__assign)({ disabled: props.hidden }, props.focusTrapProps), props.children)));
    };
