define(["require", "exports", "tslib", "react", "../../utilities/contextualMenu/index", "../../Utilities", "../../Icon"], function (require, exports, tslib_1, React, index_1, Utilities_1, Icon_1) {
    ...
    var defaultIconRenderer = function (props) {
        ...
        return React.createElement(Icon_1.Icon, (0, tslib_1.__assign)({}, iconProps, { className: classNames.icon }));
    };
    ...
    var renderSubMenuIcon = function (_a) {
        ...
        if ((0, index_1.hasSubmenu)(item)) {
            return (React.createElement(Icon_1.Icon, (0, tslib_1.__assign)({ iconName: (0, Utilities_1.getRTL)(theme) ? 'ChevronLeft' : 'ChevronRight' }, item.submenuIconProps, { className: classNames.subMenuIcon })));
        }
        return null;
    };
    var ContextualMenuItemBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ContextualMenuItemBase, _super);
