define(["require", "exports", "tslib", "react", "./ContextualMenu.types", "../../common/DirectionalHint", "../../FocusZone", "../../Utilities", "../../utilities/contextualMenu/index", "../../Callout", "./ContextualMenuItem", "./ContextualMenuItemWrapper/index", "../../Styling", "./ContextualMenu.classNames", "@fluentui/react-hooks", "../../ResponsiveMode", "../../utilities/MenuContext/index"], function (require, exports, tslib_1, React, ContextualMenu_types_1, DirectionalHint_1, FocusZone_1, Utilities_1, index_1, Callout_1, ContextualMenuItem_1, index_2, Styling_1, ContextualMenu_classNames_1, react_hooks_1, ResponsiveMode_1, index_3) {
        ...
        if (items) {
            ...
            for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                ...
                if (subItem.preferMenuTargetAsEventTarget) {
                    ...
                    var onClick = subItem.onClick, contextItem = (0, tslib_1.__rest)(subItem, ["onClick"]);
                    overrideItems.push((0, tslib_1.__assign)((0, tslib_1.__assign)({}, contextItem), { onClick: getOnClickWithOverrideTarget(onClick, target) }));
                }
                else {
    ...
    var _getMenuItemStylesFunction = (0, Utilities_1.memoizeFunction)(function () {
        ...
        return function (styleProps) {
            return Styling_1.concatStyleSetsWithProps.apply(void 0, (0, tslib_1.__spreadArray)([styleProps, ContextualMenu_classNames_1.getItemStyles], styles, false));
        };
    });
    //#region Custom hooks
    ...
    exports.ContextualMenuBase = React.memo(React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        var _a;
        var _b = (0, Utilities_1.getPropsWithDefaults)(DEFAULT_PROPS, propsWithoutDefaults), ref = _b.ref, props = (0, tslib_1.__rest)(_b, ["ref"]);
        ...
        var renderFocusZone = function (children, adjustedFocusZoneProps) {
            ...
            return React.createElement(ChildrenRenderer, (0, tslib_1.__assign)({}, adjustedFocusZoneProps), children);
        };
        /**
        ...
        menuClassNames, index, hasCheckmarks, hasIcons) {
            ...
            if (sectionProps.title) {
                ...
                if (typeof sectionProps.title === 'string') {
                    ...
                    headerContextualMenuItem = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, sectionProps.title), { id: id_2 });
                    ariaLabelledby = id_2;
                }
            ...
            if (sectionProps.items && sectionProps.items.length > 0) {
                return (React.createElement("li", { role: "presentation", key: sectionProps.key || sectionItem.key || "section-".concat(index) },
                    React.createElement("div", (0, tslib_1.__assign)({}, groupProps),
        ...
        index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
            if (item.onRender) {
                return item.onRender((0, tslib_1.__assign)({ 'aria-posinset': focusableElementIndex + 1, 'aria-setsize': totalItemCount }, item), dismiss);
            }
            ...
            if (item.href) {
                return React.createElement(index_2.ContextualMenuAnchor, (0, tslib_1.__assign)({}, commonProps, { onItemClick: onAnchorClick }));
            }
            if (item.split && (0, index_1.hasSubmenu)(item)) {
                return (React.createElement(index_2.ContextualMenuSplitButton, (0, tslib_1.__assign)({}, commonProps, { onItemClick: onItemClick, onItemClickBase: onItemClickBase, onTap: cancelSubMenuTimer })));
            }
            return React.createElement(index_2.ContextualMenuButton, (0, tslib_1.__assign)({}, commonProps, { onItemClick: onItemClick, onItemClickBase: onItemClickBase }));
        };
        ...
        menuClassNames, index, hasCheckmarks, hasIcons) {
            ...
            return (
            // eslint-disable-next-line deprecation/deprecation
            React.createElement("div", (0, tslib_1.__assign)({ id: id, className: menuClassNames.header }, divHtmlProperties, { style: item.style }),
                React.createElement(ChildrenRenderer, (0, tslib_1.__assign)({ item: item, classNames: itemClassNames, index: index, onCheckmarkClick: hasCheckmarks ? onItemClick : undefined, hasIcons: hasIcons }, itemProps))));
        };
        //#endregion
        //#region Main render
        ...
        var adjustedFocusZoneProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({ direction: FocusZone_1.FocusZoneDirection.vertical, handleTabKey: FocusZone_1.FocusZoneTabbableElements.all, isCircularNavigation: true }, focusZoneProps), { className: (0, Utilities_1.css)(classNames.root, (_a = props.focusZoneProps) === null || _a === void 0 ? void 0 : _a.className) });
