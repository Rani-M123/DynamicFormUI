define(["require", "exports", "tslib", "react", "../../Button", "./Nav.styles", "../../Utilities", "../../FocusZone", "../../Icon", "@fluentui/utilities"], function (require, exports, tslib_1, React, Button_1, Nav_styles_1, Utilities_1, FocusZone_1, Icon_1, utilities_1) {
    ...
    var NavBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(NavBase, _super);
        function NavBase(props) {
            ...
            _this._renderGroup = function (group, groupIndex) {
                ...
                var groupProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, group), { isExpanded: isExpanded, onHeaderClick: finalOnHeaderClick });
        ...
        NavBase.prototype.render = function () {
            ...
            return (React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ direction: FocusZone_1.FocusZoneDirection.vertical, componentRef: this._focusZone }, this.props.focusZoneProps),
        ...
        NavBase.prototype._renderCompositeLink = function (link, linkIndex, nestingLevel) {
            var _a;
            var divProps = (0, tslib_1.__assign)({}, (0, Utilities_1.getNativeProps)(link, Utilities_1.divProperties, ['onClick']));
            // eslint-disable-next-line deprecation/deprecation
            ...
            return (React.createElement("div", (0, tslib_1.__assign)({}, divProps, { key: link.key || linkIndex, className: classNames.compositeLink }),
        ...
        NavBase.prototype._toggleCollapsed = function (group) {
            var _a;
            if (group.name) {
                var newGroupCollapsed = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.state.isGroupCollapsed), (_a = {}, _a[group.name] = this._isGroupExpanded(group), _a));
