    ...
    var BaseButton = /** @class */ (function (_super) {
        ...
        function BaseButton(props) {
            ...
            _this._getMemoizedMenuButtonKeytipProps = (0, Utilities_1.memoizeFunction)(function (keytipProps) {
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, keytipProps), { hasMenu: true });
            });
            _this._onRenderIcon = function (buttonProps, defaultRender) {
                var iconProps = _this.props.iconProps;
                if (iconProps && (iconProps.iconName !== undefined || iconProps.imageProps)) {
                    var className = iconProps.className, imageProps = iconProps.imageProps, rest = (0, tslib_1.__rest)(iconProps, ["className", "imageProps"]);
                    // If the styles prop is specified as part of iconProps, fall back to regular Icon as FontIcon and ImageIcon
                    // do not have this prop.
                    if (iconProps.styles) {
                        return React.createElement(Icon_1.Icon, (0, tslib_1.__assign)({ className: (0, Utilities_1.css)(_this._classNames.icon, className), imageProps: imageProps }, rest));
                    }
                    if (iconProps.iconName) {
                        return React.createElement(Icon_1.FontIcon, (0, tslib_1.__assign)({ className: (0, Utilities_1.css)(_this._classNames.icon, className) }, rest));
                    }
                    if (imageProps) {
                        return React.createElement(Icon_1.ImageIcon, (0, tslib_1.__assign)({ className: (0, Utilities_1.css)(_this._classNames.icon, className), imageProps: imageProps }, rest));
                    }
                }
                return null;
            };
            ...
            _this._onRenderMenuIcon = function (props) {
                ...
                return React.createElement(Icon_1.FontIcon, (0, tslib_1.__assign)({ iconName: "ChevronDown" }, menuIconProps, { className: _this._classNames.menuIcon }));
            };
            _this._onRenderMenu = function (menuProps) {
                ...
                return React.createElement(MenuType, (0, tslib_1.__assign)({}, menuProps));
            };
        ...
        BaseButton.prototype._onRenderContent = function (tag, buttonProps) {
            ...
            var Button = function (keytipAttributes) { return (React.createElement(Tag, (0, tslib_1.__assign)({}, buttonProps, keytipAttributes),
        ...
        BaseButton.prototype._onRenderSplitButtonMenuButton = function (classNames, keytipAttributes) {
            ...
            var splitButtonProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, splitButtonMenuProps), { styles: classNames, checked: checked, disabled: disabled, allowDisabledFocus: allowDisabledFocus, onClick: this._onMenuClick, menuProps: undefined, iconProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, menuIconProps), { className: this._classNames.menuIcon }), ariaLabel: splitButtonAriaLabel, 'aria-haspopup': true, 'aria-expanded': !menuHidden, 'data-is-focusable': false });
            // Add data-ktp-execute-target to the split button if the keytip is defined
            return (React.createElement(BaseButton, (0, tslib_1.__assign)({}, splitButtonProps, { "data-ktp-execute-target": keytipAttributes ? keytipAttributes['data-ktp-execute-target'] : keytipAttributes, onMouseDown: this._onMouseDown, tabIndex: primaryDisabled && !allowDisabledFocus ? 0 : -1 })));
        };
