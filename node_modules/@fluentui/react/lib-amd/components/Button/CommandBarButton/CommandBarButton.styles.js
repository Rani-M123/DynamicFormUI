    ...
    exports.getStyles = (0, Utilities_1.memoizeFunction)(function (theme, customStyles, focusInset, focusColor) {
        ...
        var commandButtonStyles = {
            ...
            rootDisabled: {
                ...
                selectors: (_g = {},
                    _g[".".concat(BaseButton_classNames_1.ButtonGlobalClassNames.msButtonIcon)] = {
                        ...
                        selectors: (_h = {},
                            _h[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'GrayText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                            _h),
                    },
                    _g[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'GrayText', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                    _g),
            },
            // Split button styles
            ...
            splitButtonMenuButtonDisabled: {
                backgroundColor: p.white,
                selectors: (_o = {},
                    _o[Styling_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'GrayText', border: 'none', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                    _o),
            },
