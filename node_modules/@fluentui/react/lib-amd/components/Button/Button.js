        ...
        Button.prototype.render = function () {
            ...
            switch (props.buttonType) {
                case Button_types_1.ButtonType.command:
                    return React.createElement(ActionButton_1.ActionButton, (0, tslib_1.__assign)({}, props));
                case Button_types_1.ButtonType.compound:
                    return React.createElement(CompoundButton_1.CompoundButton, (0, tslib_1.__assign)({}, props));
                case Button_types_1.ButtonType.icon:
                    return React.createElement(IconButton_1.IconButton, (0, tslib_1.__assign)({}, props));
                case Button_types_1.ButtonType.primary:
                    return React.createElement(PrimaryButton_1.PrimaryButton, (0, tslib_1.__assign)({}, props));
                default:
                    return React.createElement(DefaultButton_1.DefaultButton, (0, tslib_1.__assign)({}, props));
            }
        };
        return Button;
    }(React.Component));
