define(["require", "exports", "tslib", "react", "../../Utilities", "../../Autofill", "./BaseExtendedPicker.scss", "../../FocusZone", "../../Selection"], function (require, exports, tslib_1, React, Utilities_1, Autofill_1, stylesImport, FocusZone_1, Selection_1) {
    ...
    var BaseExtendedPicker = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(BaseExtendedPicker, _super);
        ...
        BaseExtendedPicker.prototype.render = function () {
            ...
            return (React.createElement("div", { ref: this.root, className: (0, Utilities_1.css)('ms-BasePicker ms-BaseExtendedPicker', className ? className : ''), onKeyDown: this.onBackspace, onCopy: this.onCopy },
                React.createElement(FocusZone_1.FocusZone, (0, tslib_1.__assign)({ direction: FocusZone_1.FocusZoneDirection.bidirectional }, focusZoneProps),
                    React.createElement(Selection_1.SelectionZone, { selection: this.selection, selectionMode: Selection_1.SelectionMode.multiple },
                        React.createElement("div", { className: (0, Utilities_1.css)('ms-BasePicker-text', styles.pickerText), role: 'list' },
                            ...
                            this.canAddItems() && (React.createElement(Autofill_1.Autofill, (0, tslib_1.__assign)({}, inputProps, { className: (0, Utilities_1.css)('ms-BasePicker-input', styles.pickerInput), ref: this.input, onFocus: this.onInputFocus, onClick: this.onInputClick, onInputValueChange: this.onInputChange, "aria-activedescendant": activeDescendant, "aria-owns": isExpanded ? 'suggestion-list' : undefined, "aria-expanded": isExpanded, "aria-haspopup": "true", role: "combobox", disabled: disabled, onPaste: this.onPaste })))))),
        ...
        BaseExtendedPicker.prototype.renderFloatingPicker = function () {
            ...
            return (React.createElement(FloatingPicker, (0, tslib_1.__assign)({ componentRef: this.floatingPicker, onChange: this._onSuggestionSelected, onSuggestionsHidden: this._onSuggestionsShownOrHidden, onSuggestionsShown: this._onSuggestionsShownOrHidden, inputElement: this.input.current ? this.input.current.inputElement : undefined, selectedItems: this.items, suggestionItems: this.props.suggestionItems ? this.props.suggestionItems : undefined }, this.floatingPickerProps)));
        };
        BaseExtendedPicker.prototype.renderSelectedItemsList = function () {
            var SelectedItems = this.props.onRenderSelectedItems;
            return (React.createElement(SelectedItems, (0, tslib_1.__assign)({ componentRef: this.selectedItemsList, selection: this.selection, selectedItems: this.props.selectedItems ? this.props.selectedItems : undefined, onItemsDeleted: this.props.selectedItems ? this.props.onItemsRemoved : undefined }, this.selectedItemsListProps)));
        };
