define(["require", "exports", "tslib", "react", "../../Utilities", "../../OverflowSet", "../../ResizeGroup", "../../FocusZone", "../../Button", "../../Tooltip", "./CommandBar.styles"], function (require, exports, tslib_1, React, Utilities_1, OverflowSet_1, ResizeGroup_1, FocusZone_1, Button_1, Tooltip_1, CommandBar_styles_1) {
    ...
    var CommandBarBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(CommandBarBase, _super);
        function CommandBarBase(props) {
            ...
            _this._onRenderItem = function (item) {
                ...
                var commandButtonProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({ allowDisabledFocus: true, role: 'menuitem' }, item), { styles: (0, CommandBar_styles_1.getCommandButtonStyles)(item.buttonStyles), className: (0, Utilities_1.css)('ms-CommandBarItem-link', item.className), text: !item.iconOnly ? itemText : undefined, menuProps: item.subMenuProps, onClick: _this._onButtonClick(item) });
                if (item.iconOnly && (itemText !== undefined || item.tooltipHostProps)) {
                    return (React.createElement(Tooltip_1.TooltipHost, (0, tslib_1.__assign)({ role: "none", content: itemText, setAriaDescribedBy: false }, item.tooltipHostProps), _this._commandButton(item, commandButtonProps)));
                }
            ...
            _this._commandButton = function (item, props) {
                ...
                return React.createElement(Type, (0, tslib_1.__assign)({}, props));
            };
            _this._onRenderOverflowButton = function (overflowItems) {
                ...
                var combinedOverflowItems = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (overflowButtonProps.menuProps ? overflowButtonProps.menuProps.items : []), true), overflowItems, true);
                var overflowProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({ role: 'menuitem' }, overflowButtonProps), { styles: (0, tslib_1.__assign)({ menuIcon: { fontSize: '17px' } }, overflowButtonProps.styles), className: (0, Utilities_1.css)('ms-CommandBar-overflowButton', overflowButtonProps.className), menuProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, overflowButtonProps.menuProps), { items: combinedOverflowItems }), menuIconProps: (0, tslib_1.__assign)({ iconName: 'More' }, overflowButtonProps.menuIconProps) });
                ...
                return React.createElement(OverflowButtonType, (0, tslib_1.__assign)({}, overflowProps));
            };
            _this._onReduceData = function (data) {
                ...
                if (movedItem !== undefined) {
                    ...
                    overflowItems = (0, tslib_1.__spreadArray)([movedItem], overflowItems, true);
                    primaryItems = shiftOnReduce ? primaryItems.slice(1) : primaryItems.slice(0, -1);
                    var newData = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, data), { primaryItems: primaryItems, overflowItems: overflowItems });
            ...
            _this._onGrowData = function (data) {
                ...
                if (movedItem !== undefined && overflowItems.length > minimumOverflowItems) {
                    ...
                    primaryItems = shiftOnReduce ? (0, tslib_1.__spreadArray)([movedItem], primaryItems, true) : (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], primaryItems, true), [movedItem], false);
                    var newData = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, data), { primaryItems: primaryItems, overflowItems: overflowItems });
                    cacheKey = _this._computeCacheKey({ primaryItems: primaryItems, overflow: overflowItems.length > 0, farItems: farItems });
                    if (onDataGrown) {
        ...
        CommandBarBase.prototype.render = function () {
            ...
            var commandBarData = {
                primaryItems: (0, tslib_1.__spreadArray)([], items, true),
                overflowItems: (0, tslib_1.__spreadArray)([], overflowItems, true),
                minimumOverflowItems: (0, tslib_1.__spreadArray)([], overflowItems, true).length,
                farItems: farItems,
            ...
            return (React.createElement(ResizeGroupAs, (0, tslib_1.__assign)({}, nativeProps, { componentRef: this._resizeGroup, data: commandBarData, onReduceData: onReduceData, onGrowData: onGrowData, onRenderData: this._onRenderData, dataDidRender: dataDidRender })));
        };
