define(["require", "exports", "tslib", "../../Utilities"], function (require, exports, tslib_1, Utilities_1) {
    ...
    exports.getCommandButtonStyles = (0, Utilities_1.memoizeFunction)(function (customStyles) {
        ...
        var _a = customStyles || {}, root = _a.root, label = _a.label, restCustomStyles = (0, tslib_1.__rest)(_a, ["root", "label"]);
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, restCustomStyles), { root: root ? [rootStyles, root] : rootStyles, label: label ? [labelStyles, label] : labelStyles });
    });
});
