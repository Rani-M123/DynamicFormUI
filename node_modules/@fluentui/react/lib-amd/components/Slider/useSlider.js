define(["require", "exports", "tslib", "react", "@fluentui/react-hooks", "@fluentui/utilities"], function (require, exports, tslib_1, React, react_hooks_1, utilities_1) {
    ...
    var useSlider = function (props, ref) {
        ...
        var sliderProps = (0, tslib_1.__assign)({ 'aria-disabled': disabled, role: 'slider', tabIndex: disabled ? undefined : 0 }, { 'data-is-focusable': !disabled });
        var sliderBoxProps = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ id: id, className: (0, utilities_1.css)(classNames.slideBox, buttonProps.className), ref: sliderBoxRef }, (!disabled && {
            onMouseDown: onMouseDownOrTouchStart,
            onTouchStart: onMouseDownOrTouchStart,
            onKeyDown: onKeyDown,
        })), (buttonProps &&
            (0, utilities_1.getNativeProps)(buttonProps, utilities_1.divProperties, ['id', 'className']))), (!ranged && (0, tslib_1.__assign)((0, tslib_1.__assign)({}, sliderProps), { 'aria-valuemin': min, 'aria-valuemax': max, 'aria-valuenow': value, 'aria-valuetext': getAriaValueText(value), 'aria-label': ariaLabel || label, 'aria-labelledby': ariaLabelledBy })));
        var onFocusProp = disabled ? {} : { onFocus: onThumbFocus };
        var thumbProps = (0, tslib_1.__assign)({ ref: thumbRef, className: classNames.thumb, style: getPositionStyles(valuePercent) }, (ranged && (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, sliderProps), onFocusProp), { id: "max-".concat(id), 'aria-valuemin': lowerValue, 'aria-valuemax': max, 'aria-valuenow': value, 'aria-valuetext': getAriaValueText(value), 'aria-label': "max ".concat(ariaLabel || label) })));
        var lowerValueThumbProps = ranged
            ? (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ ref: lowerValueThumbRef, className: classNames.thumb, style: getPositionStyles(lowerValuePercent) }, sliderProps), onFocusProp), { id: "min-".concat(id), 'aria-valuemin': min, 'aria-valuemax': value, 'aria-valuenow': lowerValue, 'aria-valuetext': getAriaValueText(lowerValue), 'aria-label': "min ".concat(ariaLabel || label) }) : undefined;
        var containerProps = {
