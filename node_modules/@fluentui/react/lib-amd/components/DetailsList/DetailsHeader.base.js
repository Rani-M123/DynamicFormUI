define(["require", "exports", "tslib", "react", "../../Utilities", "./DetailsList.types", "../../FocusZone", "../../Icon", "../../Layer", "../GroupedList/GroupSpacer", "../../GroupedList", "./DetailsRowCheck", "../../Selection", "../../DragDrop", "../../components/DetailsList/DetailsColumn", "./DetailsHeader.types"], function (require, exports, tslib_1, React, Utilities_1, DetailsList_types_1, FocusZone_1, Icon_1, Layer_1, GroupSpacer_1, GroupedList_1, DetailsRowCheck_1, Selection_1, DragDrop_1, DetailsColumn_1, DetailsHeader_types_1) {
    ...
    var DetailsHeaderBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(DetailsHeaderBase, _super);
            ...
            _this._onRootKeyDown = function (ev) {
                ...
                if (!columnResizeDetails) {
                    ...
                    if (increment) {
                        ...
                        _this.setState({
                            columnResizeDetails: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, columnResizeDetails), { columnMinWidth: columnResizeDetails.columnMinWidth + increment }),
                        });
                        if (onColumnResized) {
        ...
        DetailsHeaderBase.prototype._getColumnReorderProps = function () {
            ...
            return columnReorderProps || (columnReorderOptions && (0, tslib_1.__assign)((0, tslib_1.__assign)({}, columnReorderOptions), { onColumnDragEnd: undefined }));
        };
