define(["require", "exports", "tslib", "react", "@fluentui/react-hooks", "@fluentui/utilities", "../Label/Label"], function (require, exports, tslib_1, React, react_hooks_1, utilities_1, Label_1) {
    ...
    exports.ToggleBase = React.forwardRef(function (props, forwardedRef) {
        ...
        return (React.createElement(RootType, (0, tslib_1.__assign)({ ref: forwardedRef }, slotProps.root),
            label && React.createElement(Label_1.Label, (0, tslib_1.__assign)({}, slotProps.label)),
            React.createElement("div", (0, tslib_1.__assign)({}, slotProps.container),
                React.createElement("button", (0, tslib_1.__assign)({}, slotProps.pill),
                    React.createElement("span", (0, tslib_1.__assign)({}, slotProps.thumb))),
                ((checked && onText) || offText) && React.createElement(Label_1.Label, (0, tslib_1.__assign)({}, slotProps.stateText)))));
    });
