    ...
    var TimePicker = function (_a) {
        ...
        var onInputChange = React.useCallback(function (ev, option, _index, input) {
            ...
            if (errorMessageToDisplay || (input !== undefined && !input.length)) {
                ...
                var updatedTime = (0, date_time_utilities_1.getDateFromTimeSelection)(useHour12, dateStartAnchor, timeSelection);
        ...
        return (React.createElement(ComboBox_1.ComboBox, (0, tslib_1.__assign)({}, rest, { allowFreeform: allowFreeform, selectedKey: selectedKey, label: label, errorMessage: errorMessage, options: timePickerOptions, onChange: onInputChange, text: comboBoxText, 
