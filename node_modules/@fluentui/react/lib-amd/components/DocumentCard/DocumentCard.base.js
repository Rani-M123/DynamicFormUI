define(["require", "exports", "tslib", "react", "../../Utilities", "./DocumentCard.types"], function (require, exports, tslib_1, React, Utilities_1, DocumentCard_types_1) {
    ...
    var DocumentCardBase = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(DocumentCardBase, _super);
        ...
        DocumentCardBase.prototype.render = function () {
            ...
            return (React.createElement("div", (0, tslib_1.__assign)({ ref: this._rootElement, role: 'group', className: this._classNames.root, onKeyDown: actionable ? this._onKeyDown : undefined, onClick: actionable ? this._onClick : undefined, style: style }, nativeProps),
