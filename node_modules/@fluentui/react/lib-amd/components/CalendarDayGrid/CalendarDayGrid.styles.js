        ...
        return {
            ...
            dayCell: [
                (0, style_utilities_1.getFocusStyle)(theme, { inset: -3 }),
                {
                    ...
                    position: 'relative',
                    selectors: (_a = {},
                        _a[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ color: 'WindowText', backgroundColor: 'transparent', zIndex: 0 }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                ...
                dateRangeType !== date_time_utilities_1.DateRangeType.Month && {
                    ...
                    selectors: (_e = {
                        ...
                        _e['&:hover, &.' + classNames.hoverStyle + ', &.' + classNames.pressedStyle] = (_f = {
                            ...
                            _f),
                        _e[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ background: 'Highlight!important', color: 'HighlightText!important', borderColor: 'Highlight!important' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                        _e),
                },
            ],
            ...
            dayIsToday: {
                ...
                selectors: (_g = {},
                    _g[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ background: 'WindowText!important', color: 'Window!important', borderColor: 'WindowText!important' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                    _g),
            },
            firstTransitionWeek: (0, tslib_1.__assign)((0, tslib_1.__assign)({ position: 'absolute', opacity: 0, width: 0, height: 0, overflow: 'hidden' }, firstTransitionRowAnimationStyle), { animationName: firstTransitionRowAnimationStyle.animationName + ',' + transitionRowDisappearance }),
            lastTransitionWeek: (0, tslib_1.__assign)((0, tslib_1.__assign)({ position: 'absolute', opacity: 0, width: 0, height: 0, overflow: 'hidden', marginTop: -28 }, lastTransitionRowAnimationStyle), { animationName: lastTransitionRowAnimationStyle.animationName + ',' + transitionRowDisappearance }),
            dayMarker: {
                width: 4,
                height: 4,
                ...
                selectors: (_h = {},
                    ...
                    _h[style_utilities_1.HighContrastSelector] = (0, tslib_1.__assign)({ backgroundColor: 'WindowText' }, (0, style_utilities_1.getHighContrastNoAdjustStyle)()),
                    _h),
            },
            topRightCornerDate: {
