define(["require", "exports", "tslib", "../../Styling", "../../Utilities", "../../Positioning"], function (require, exports, tslib_1, Styling_1, Utilities_1, Positioning_1) {
    ...
    var getStyles = function (props) {
        ...
        return {
            ...
            spinButtonWrapper: [
                (0, tslib_1.__assign)((0, tslib_1.__assign)({ display: 'flex', position: 'relative', boxSizing: 'border-box', height: DEFAULT_HEIGHT, minWidth: DEFAULT_MIN_WIDTH }, (0, Styling_1.getInputFocusStyle)(SpinButtonRootBorderColor, effects.roundedCorner2, 'border', 0)), { ':after': (_a = {
                            borderWidth: '1px'
                        },
                        _a[Styling_1.HighContrastSelector] = {
