define(["require", "exports", "tslib", "react", "../../../../Utilities", "./EditingItem.styles"], function (require, exports, tslib_1, React, Utilities_1, EditingItem_styles_1) {
    ...
    var EditingItem = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(EditingItem, _super);
        function EditingItem(props) {
            ...
            _this._renderEditingSuggestions = function () {
                ...
                return (React.createElement(FloatingPicker, (0, tslib_1.__assign)({ componentRef: _this._editingFloatingPicker, onChange: _this._onSuggestionSelected, inputElement: _this._editingInput, selectedItems: [] }, floatingPickerProps)));
            };
        ...
        EditingItem.prototype.render = function () {
            ...
            return (React.createElement("div", { "aria-labelledby": 'editingItemPersona-' + itemId, className: classNames.root },
                React.createElement("input", (0, tslib_1.__assign)({ autoCapitalize: 'off', autoComplete: 'off' }, nativeProps, { ref: this._resolveInputRef, onChange: this._onInputChange, onKeyDown: this._onInputKeyDown, onBlur: this._onInputBlur, onClick: this._onInputClick, "data-lpignore": true, className: classNames.input, id: itemId })),
