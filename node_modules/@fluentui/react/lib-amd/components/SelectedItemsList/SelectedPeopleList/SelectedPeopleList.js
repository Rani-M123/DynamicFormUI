define(["require", "exports", "tslib", "react", "../BaseSelectedItemsList", "./Items/ExtendedSelectedItem", "./Items/SelectedItemWithContextMenu", "./Items/EditingItem"], function (require, exports, tslib_1, React, BaseSelectedItemsList_1, ExtendedSelectedItem_1, SelectedItemWithContextMenu_1, EditingItem_1) {
    ...
    var BasePeopleSelectedItemsList = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(BasePeopleSelectedItemsList, _super);
    ...
    var SelectedPeopleList = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(SelectedPeopleList, _super);
        ...
        SelectedPeopleList.prototype._renderItem = function (item, index) {
            ...
            if (item.isEditing && hasContextMenu) {
                return (React.createElement(EditingItem_1.EditingItem, (0, tslib_1.__assign)({}, props, { onRenderFloatingPicker: this.props.onRenderFloatingPicker, floatingPickerProps: this.props.floatingPickerProps, onEditingComplete: this._completeEditing, getEditingItemText: this.props.getEditingItemText })));
            }
            else {
        ...
        SelectedPeopleList.defaultProps = {
            onRenderItem: function (props) { return React.createElement(ExtendedSelectedItem_1.ExtendedSelectedItem, (0, tslib_1.__assign)({}, props)); },
        };
