define(["require", "exports", "tslib", "react", "../../Utilities", "./TeachingBubbleContent", "../../Callout", "../../common/DirectionalHint", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, Utilities_1, TeachingBubbleContent_1, Callout_1, DirectionalHint_1, react_hooks_1) {
    ...
    exports.TeachingBubbleBase = React.forwardRef(function (props, forwardedRef) {
        ...
        var calloutProps = React.useMemo(function () { return ((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, defaultCalloutProps), setCalloutProps), { theme: theme })); }, [setCalloutProps, theme]);
        var stylesProps = {
            theme: theme,
            isWide: isWide,
        ...
        return (React.createElement(Callout_1.Callout, (0, tslib_1.__assign)({ target: target || targetElement, onDismiss: onDismiss }, calloutProps, { className: classNames.root, styles: calloutStyles, hideOverflow: true }),
            React.createElement("div", { ref: mergedRootRef },
                React.createElement(TeachingBubbleContent_1.TeachingBubbleContent, (0, tslib_1.__assign)({}, props)))));
    });
