define(["require", "exports", "tslib", "../../common/DirectionalHint", "../../Utilities", "./positioning.types", "../../Utilities"], function (require, exports, tslib_1, DirectionalHint_1, Utilities_1, positioning_types_1, Utilities_2) {
    ...
    function _getPositionData(directionalHint, directionalHintForRTL, previousPositions) {
        ...
        var positionInformation = (0, tslib_1.__assign)({}, DirectionalDictionary[directionalHint]);
        if ((0, Utilities_1.getRTL)()) {
    ...
    function _finalizeBeakPosition(elementPosition, positionedBeak, bounds) {
        ...
        return {
            elementPosition: (0, tslib_1.__assign)({}, returnValue),
    ...
    function _positionElementRelative(props, elementToPosition, boundingRect, previousPositions) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, positionedElement), { targetRectangle: targetRect });
    }
    ...
    function _positionCallout(props, hostElement, callout, previousPositions, doNotFinalizeReturnEdge) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _finalizePositionData(positionedElement, hostElement, boundingRect, props.coverTarget, doNotFinalizeReturnEdge)), { beakPosition: finalizedBeakPosition });
    }
